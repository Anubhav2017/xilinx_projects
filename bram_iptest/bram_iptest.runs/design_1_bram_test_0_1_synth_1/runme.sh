...
HD_PWD='/home/anubhav/xilinx_projects/bram_iptest/bram_iptest.runs/design_1_bram_test_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_bram_test_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_bram_test_0_1.tcl
