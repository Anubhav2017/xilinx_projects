; ModuleID = '/home/anubhav/xilinx_projects/ip_repo/relu_fwd/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_relu_fwd_ir(%struct.ap_fixed* %x, %struct.ap_fixed* %y, i32 %dim) local_unnamed_addr #0 {
entry:
  ...
  %1 = bitcast %struct.ap_fixed* %y to [200 x %struct.ap_fixed]*
  call fastcc void @copy_in([200 x %struct.ap_fixed]* %0, [200 x %struct.ap_fixed]* nonnull align 512 %x_copy, [200 x %struct.ap_fixed]* %1, [200 x %struct.ap_fixed]* nonnull align 512 %y_copy)
  %2 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %x_copy, i32 0, i32 0
  %3 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %y_copy, i32 0, i32 0
  call void @apatb_relu_fwd_hw(%struct.ap_fixed* %2, %struct.ap_fixed* %3, i32 %dim)
  call fastcc void @copy_out([200 x %struct.ap_fixed]* %0, [200 x %struct.ap_fixed]* nonnull align 512 %x_copy, [200 x %struct.ap_fixed]* %1, [200 x %struct.ap_fixed]* nonnull align 512 %y_copy)
  ret void
}
...
; Function Attrs: noinline
define internal fastcc void @copy_out([200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_relu_fwd_hw(%struct.ap_fixed*, %struct.ap_fixed*, i32)

define void @relu_fwd_hw_stub_wrapper(%struct.ap_fixed*, %struct.ap_fixed*, i32) #6 {
entry:
  %3 = bitcast %struct.ap_fixed* %0 to [200 x %struct.ap_fixed]*
  %4 = bitcast %struct.ap_fixed* %1 to [200 x %struct.ap_fixed]*
  call void @copy_out([200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %3, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %4)
  %5 = bitcast [200 x %struct.ap_fixed]* %3 to %struct.ap_fixed*
  %6 = bitcast [200 x %struct.ap_fixed]* %4 to %struct.ap_fixed*
  call void @relu_fwd_hw_stub(%struct.ap_fixed* %5, %struct.ap_fixed* %6, i32 %2)
  call void @copy_in([200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %3, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %4)
  ret void
}

declare void @relu_fwd_hw_stub(%struct.ap_fixed*, %struct.ap_fixed*, i32)
