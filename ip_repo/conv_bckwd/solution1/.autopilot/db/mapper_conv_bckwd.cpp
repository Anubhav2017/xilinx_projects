...
extern "C" void conv_bckwd(int*, int, int, int, int, int, int, int, int, int, int, int, int, int);
extern "C" void apatb_conv_bckwd_hw(volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_w, volatile void * __xlx_apatb_param_y, volatile void * __xlx_apatb_param_dx, volatile void * __xlx_apatb_param_dw, volatile void * __xlx_apatb_param_db, volatile void * __xlx_apatb_param_dy, int __xlx_apatb_param_F, int __xlx_apatb_param_C, int __xlx_apatb_param_H, int __xlx_apatb_param_W, int __xlx_apatb_param_FH, int __xlx_apatb_param_FW) {
  ...
  vector<sc_bv<32> >__xlx_x_w_y_dx_dw_db_dy__tmp_vec;
  for (int j = 0, e = 200; j != e; ++j) {
    __xlx_x_w_y_dx_dw_db_dy__tmp_vec.push_back(((int*)__xlx_apatb_param_x)[j]);
  }
  int __xlx_size_param_x = 200;
  int __xlx_offset_param_x = 0;
  int __xlx_offset_byte_param_x = 0*4;
  for (int j = 0, e = 200; j != e; ++j) {
    __xlx_x_w_y_dx_dw_db_dy__tmp_vec.push_back(((int*)__xlx_apatb_param_w)[j]);
  }
  int __xlx_size_param_w = 200;
  int __xlx_offset_param_w = 200;
  int __xlx_offset_byte_param_w = 200*4;
  for (int j = 0, e = 200; j != e; ++j) {
    __xlx_x_w_y_dx_dw_db_dy__tmp_vec.push_back(((int*)__xlx_apatb_param_y)[j]);
  }
  int __xlx_size_param_y = 200;
  int __xlx_offset_param_y = 400;
  int __xlx_offset_byte_param_y = 400*4;
  for (int j = 0, e = 200; j != e; ++j) {
    __xlx_x_w_y_dx_dw_db_dy__tmp_vec.push_back(((int*)__xlx_apatb_param_dx)[j]);
  }
  int __xlx_size_param_dx = 200;
  int __xlx_offset_param_dx = 600;
  int __xlx_offset_byte_param_dx = 600*4;
  for (int j = 0, e = 200; j != e; ++j) {
    __xlx_x_w_y_dx_dw_db_dy__tmp_vec.push_back(((int*)__xlx_apatb_param_dw)[j]);
  }
  int __xlx_size_param_dw = 200;
  int __xlx_offset_param_dw = 800;
  int __xlx_offset_byte_param_dw = 800*4;
  for (int j = 0, e = 200; j != e; ++j) {
    __xlx_x_w_y_dx_dw_db_dy__tmp_vec.push_back(((int*)__xlx_apatb_param_db)[j]);
  }
  int __xlx_size_param_db = 200;
  int __xlx_offset_param_db = 1000;
  int __xlx_offset_byte_param_db = 1000*4;
  for (int j = 0, e = 200; j != e; ++j) {
    __xlx_x_w_y_dx_dw_db_dy__tmp_vec.push_back(((int*)__xlx_apatb_param_dy)[j]);
  }
  int __xlx_size_param_dy = 200;
  int __xlx_offset_param_dy = 1200;
  int __xlx_offset_byte_param_dy = 1200*4;
  int* __xlx_x_w_y_dx_dw_db_dy__input_buffer= new int[__xlx_x_w_y_dx_dw_db_dy__tmp_vec.size()];
  for (int i = 0; i < __xlx_x_w_y_dx_dw_db_dy__tmp_vec.size(); ++i) {
    __xlx_x_w_y_dx_dw_db_dy__input_buffer[i] = __xlx_x_w_y_dx_dw_db_dy__tmp_vec[i].range(31, 0).to_uint64();
  }
  // DUT call
