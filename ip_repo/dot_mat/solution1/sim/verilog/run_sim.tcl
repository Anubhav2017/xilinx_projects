...
if {[file isfile dot_matrix.autotvin.dat]} {
	file delete -force dot_matrix.autotvin.dat
}

if {[file isfile dot_matrix.autotvout.dat]} {
	file delete -force dot_matrix.autotvout.dat
}
