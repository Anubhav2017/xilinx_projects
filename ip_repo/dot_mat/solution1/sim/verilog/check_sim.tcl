...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.dot_matrix.autotvin_gmem.dat"
         "c.dot_matrix.autotvin_a.dat"
         "c.dot_matrix.autotvin_b.dat"
         "c.dot_matrix.autotvin_c.dat"
         "c.dot_matrix.autotvout_gmem.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.dot_matrix.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
