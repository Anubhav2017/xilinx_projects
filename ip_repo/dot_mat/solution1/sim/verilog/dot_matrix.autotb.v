...
`define AUTOTB_DUT      dot_matrix
`define AUTOTB_DUT_INST AESL_inst_dot_matrix
`define AUTOTB_TOP      apatb_dot_matrix_top
`define AUTOTB_LAT_RESULT_FILE "dot_matrix.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "dot_matrix.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_dot_matrix_top
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.dot_matrix.autotvin_gmem.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.dot_matrix.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.dot_matrix.autotvin_b.dat"
`define AUTOTB_TVIN_c_out_wrapc  "../tv/rtldatafile/rtl.dot_matrix.autotvin_c.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.dot_matrix.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.dot_matrix.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 214;
parameter LENGTH_gmem = 27;
