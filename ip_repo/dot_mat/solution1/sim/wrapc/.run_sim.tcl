...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "dot_matrix.autotvin.dat"
	set constFileTvOut       "dot_matrix.autotvout.dat"
	set constFileHdlTvIn     "dot_matrix.autohdltvin.dat"
	set constFileHdlTvOut    "dot_matrix.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
