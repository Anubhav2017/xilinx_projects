...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "a","cData": "int","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "a","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "b","cData": "int","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "b","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "c","cData": "int","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "c","bundle": "control"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "c", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":32}, "offset_end" : {"in":39}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"dot_matrix","role":"start","value":"0","valid_bit":"0"},{"name":"dot_matrix","role":"continue","value":"0","valid_bit":"4"},{"name":"dot_matrix","role":"auto_start","value":"0","valid_bit":"7"},{"name":"a","role":"data","value":"16"},{"name":"b","role":"data","value":"24"},{"name":"c","role":"data","value":"32"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"dot_matrix","role":"start","value":"0","valid_bit":"0"},{"name":"dot_matrix","role":"done","value":"0","valid_bit":"1"},{"name":"dot_matrix","role":"idle","value":"0","valid_bit":"2"},{"name":"dot_matrix","role":"ready","value":"0","valid_bit":"3"},{"name":"dot_matrix","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.c_t_U", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	dot_matrix {
		gmem {Type IO LastRead 14 FirstWrite 17}
		a {Type I LastRead 0 FirstWrite -1}
		b {Type I LastRead 0 FirstWrite -1}
		c {Type I LastRead 0 FirstWrite -1}
		c_t {Type IO LastRead -1 FirstWrite -1}}}
