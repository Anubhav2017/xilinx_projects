...
`define AUTOTB_TVIN_gmem  "./c.dot_matrix.autotvin_gmem.dat"
`define AUTOTB_TVIN_a  "./c.dot_matrix.autotvin_a.dat"
`define AUTOTB_TVIN_b  "./c.dot_matrix.autotvin_b.dat"
`define AUTOTB_TVIN_c  "./c.dot_matrix.autotvin_c.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.dot_matrix.autotvin_gmem.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.dot_matrix.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.dot_matrix.autotvin_b.dat"
`define AUTOTB_TVIN_c_out_wrapc  "./rtl.dot_matrix.autotvin_c.dat"
`define AUTOTB_TVOUT_gmem  "./c.dot_matrix.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.dot_matrix.autotvout_gmem.dat"
module `AUTOTB_TOP;
