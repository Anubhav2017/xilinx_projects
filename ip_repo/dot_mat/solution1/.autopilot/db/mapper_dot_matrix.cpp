...
extern "C" void dot_matrix(int*, int, int, int);
extern "C" void apatb_dot_matrix_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c) {
  ...
  int __xlx_offset_param_b = 9;
  int __xlx_offset_byte_param_b = 9*4;
  for (int j = 0, e = 9; j != e; ++j) {
    __xlx_a_b_c__tmp_vec.push_back(((int*)__xlx_apatb_param_c)[j]);
  }
  int __xlx_size_param_c = 9;
  int __xlx_offset_param_c = 18;
  int __xlx_offset_byte_param_c = 18*4;
  ...
  // DUT call
  dot_matrix(__xlx_a_b_c__input_buffer, __xlx_offset_byte_param_a, __xlx_offset_byte_param_b, __xlx_offset_byte_param_c);
