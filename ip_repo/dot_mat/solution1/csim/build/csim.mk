...
HLS_SOURCES = ../../../tb.cpp ../../../dot_matrix.cpp
...
$(ObjDir)/dot_matrix.o: ../../../dot_matrix.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../dot_matrix.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/dot_matrix.d
