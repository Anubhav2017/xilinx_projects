; ModuleID = '/home/anubhav/xilinx_projects/ip_repo/conv_fwd/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_conv_fwd_ir(%struct.ap_fixed* %x, %struct.ap_fixed* %w, %struct.ap_fixed* %y, %struct.ap_fixed* %b, i32 %F, i32 %C, i32 %H, i32 %W, i32 %FH, i32 %FW) local_unnamed_addr #0 {
entry:
  ...
  %3 = bitcast %struct.ap_fixed* %b to [200 x %struct.ap_fixed]*
  call fastcc void @copy_in([200 x %struct.ap_fixed]* %0, [200 x %struct.ap_fixed]* nonnull align 512 %x_copy, [200 x %struct.ap_fixed]* %1, [200 x %struct.ap_fixed]* nonnull align 512 %w_copy, [200 x %struct.ap_fixed]* %2, [200 x %struct.ap_fixed]* nonnull align 512 %y_copy, [200 x %struct.ap_fixed]* %3, [200 x %struct.ap_fixed]* nonnull align 512 %b_copy)
  %4 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %x_copy, i32 0, i32 0
  %5 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %w_copy, i32 0, i32 0
  %6 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %y_copy, i32 0, i32 0
  %7 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %b_copy, i32 0, i32 0
  call void @apatb_conv_fwd_hw(%struct.ap_fixed* %4, %struct.ap_fixed* %5, %struct.ap_fixed* %6, %struct.ap_fixed* %7, i32 %F, i32 %C, i32 %H, i32 %W, i32 %FH, i32 %FW)
...
; Function Attrs: noinline
define internal fastcc void @copy_in([200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_conv_fwd_hw(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32, i32, i32, i32, i32, i32)

define void @conv_fwd_hw_stub_wrapper(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32, i32, i32, i32, i32, i32) #6 {
entry:
  %10 = bitcast %struct.ap_fixed* %0 to [200 x %struct.ap_fixed]*
  %11 = bitcast %struct.ap_fixed* %1 to [200 x %struct.ap_fixed]*
  %12 = bitcast %struct.ap_fixed* %2 to [200 x %struct.ap_fixed]*
  %13 = bitcast %struct.ap_fixed* %3 to [200 x %struct.ap_fixed]*
  call void @copy_out([200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %10, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %11, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %12, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %13)
  %14 = bitcast [200 x %struct.ap_fixed]* %10 to %struct.ap_fixed*
  %15 = bitcast [200 x %struct.ap_fixed]* %11 to %struct.ap_fixed*
  %16 = bitcast [200 x %struct.ap_fixed]* %12 to %struct.ap_fixed*
  %17 = bitcast [200 x %struct.ap_fixed]* %13 to %struct.ap_fixed*
  call void @conv_fwd_hw_stub(%struct.ap_fixed* %14, %struct.ap_fixed* %15, %struct.ap_fixed* %16, %struct.ap_fixed* %17, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9)
  call void @copy_in([200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %10, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %11, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %12, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %13)
  ret void
}

declare void @conv_fwd_hw_stub(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32, i32, i32, i32, i32, i32)
