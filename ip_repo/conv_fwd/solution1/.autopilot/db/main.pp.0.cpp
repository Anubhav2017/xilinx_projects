...
__attribute__((sdx_kernel("conv_fwd", 0))) void conv_fwd(volatile float* x, volatile float* w, volatile float* y, volatile float* b, int F, int C, int H, int W, int FH, int FW){
...
#pragma HLS INTERFACE s_axilite port=FW bundle=CTRL
 ...
 float xbuf[10][100][100];
    ...
    float ybuf[10][100][100];
    float bbuf[10];

    VITIS_LOOP_34_1: for(int i=0;i<C;i++){
        VITIS_LOOP_35_2: for(int j=0;j<H;j++){
            VITIS_LOOP_36_3: for(int k=0;k<W;k++){
    ...
    VITIS_LOOP_44_4: for(int i=0;i<F;i++){
        VITIS_LOOP_45_5: for(int j=0;j<C;j++){
            VITIS_LOOP_46_6: for(int k=0;k<FH;k++){
                VITIS_LOOP_47_7: for(int l=0;l<FW;l++){
    ...
    VITIS_LOOP_54_8: for(int i=0;i<F;i++){
        bbuf[i] = b[i];
    }

    VITIS_LOOP_58_9: for(int f=0;f<F;f++){
        VITIS_LOOP_59_10: for(int c=0;c<C;c++){
            VITIS_LOOP_60_11: for(int h=0;h<outH;h++){
                VITIS_LOOP_61_12: for(int w=0;w<outW;w++){
                    ybuf[f][h][w]=bbuf[f];
                    VITIS_LOOP_63_13: for(int fh=0;fh<FH;fh++){
                        VITIS_LOOP_64_14: for(int fw=0;fw<FW;fw++){
    ...
    VITIS_LOOP_74_15: for(int i=0;i<F;i++){
        VITIS_LOOP_75_16: for(int j=0;j<outH;j++){
            VITIS_LOOP_76_17: for(int k=0;k<outW;k++){
