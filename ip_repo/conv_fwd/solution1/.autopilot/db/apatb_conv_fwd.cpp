...
// wrapc file define:
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.conv_fwd.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.conv_fwd.autotvout_gmem.dat"
// wrapc file define:
#define AUTOTB_TVIN_x "../tv/cdatafile/c.conv_fwd.autotvin_x.dat"
#define AUTOTB_TVOUT_x "../tv/cdatafile/c.conv_fwd.autotvout_x.dat"
// wrapc file define:
#define AUTOTB_TVIN_w "../tv/cdatafile/c.conv_fwd.autotvin_w.dat"
#define AUTOTB_TVOUT_w "../tv/cdatafile/c.conv_fwd.autotvout_w.dat"
// wrapc file define:
#define AUTOTB_TVIN_y "../tv/cdatafile/c.conv_fwd.autotvin_y.dat"
#define AUTOTB_TVOUT_y "../tv/cdatafile/c.conv_fwd.autotvout_y.dat"
// wrapc file define:
#define AUTOTB_TVIN_b "../tv/cdatafile/c.conv_fwd.autotvin_b.dat"
#define AUTOTB_TVOUT_b "../tv/cdatafile/c.conv_fwd.autotvout_b.dat"
// wrapc file define:
#define AUTOTB_TVIN_F "../tv/cdatafile/c.conv_fwd.autotvin_F.dat"
#define AUTOTB_TVOUT_F "../tv/cdatafile/c.conv_fwd.autotvout_F.dat"
// wrapc file define:
#define AUTOTB_TVIN_C "../tv/cdatafile/c.conv_fwd.autotvin_C.dat"
#define AUTOTB_TVOUT_C "../tv/cdatafile/c.conv_fwd.autotvout_C.dat"
// wrapc file define:
#define AUTOTB_TVIN_H "../tv/cdatafile/c.conv_fwd.autotvin_H.dat"
#define AUTOTB_TVOUT_H "../tv/cdatafile/c.conv_fwd.autotvout_H.dat"
// wrapc file define:
#define AUTOTB_TVIN_W "../tv/cdatafile/c.conv_fwd.autotvin_W_r.dat"
#define AUTOTB_TVOUT_W "../tv/cdatafile/c.conv_fwd.autotvout_W_r.dat"
// wrapc file define:
#define AUTOTB_TVIN_FH "../tv/cdatafile/c.conv_fwd.autotvin_FH.dat"
#define AUTOTB_TVOUT_FH "../tv/cdatafile/c.conv_fwd.autotvout_FH.dat"
// wrapc file define:
#define AUTOTB_TVIN_FW "../tv/cdatafile/c.conv_fwd.autotvin_FW.dat"
#define AUTOTB_TVOUT_FW "../tv/cdatafile/c.conv_fwd.autotvout_FW.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.conv_fwd.autotvout_gmem.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_x "../tv/rtldatafile/rtl.conv_fwd.autotvout_x.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_w "../tv/rtldatafile/rtl.conv_fwd.autotvout_w.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_y "../tv/rtldatafile/rtl.conv_fwd.autotvout_y.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_b "../tv/rtldatafile/rtl.conv_fwd.autotvout_b.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_F "../tv/rtldatafile/rtl.conv_fwd.autotvout_F.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_C "../tv/rtldatafile/rtl.conv_fwd.autotvout_C.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_H "../tv/rtldatafile/rtl.conv_fwd.autotvout_H.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_W "../tv/rtldatafile/rtl.conv_fwd.autotvout_W_r.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_FH "../tv/rtldatafile/rtl.conv_fwd.autotvout_FH.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_FW "../tv/rtldatafile/rtl.conv_fwd.autotvout_FW.dat"
...
extern "C" void conv_fwd_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, int, int, int, int, int, int);

extern "C" void apatb_conv_fwd_hw(volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_w, volatile void * __xlx_apatb_param_y, volatile void * __xlx_apatb_param_b, int __xlx_apatb_param_F, int __xlx_apatb_param_C, int __xlx_apatb_param_H, int __xlx_apatb_param_W, int __xlx_apatb_param_FH, int __xlx_apatb_param_FW) {
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > gmem_pc_buffer(800);
          int i = 0;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_x)[j];
  ...
  __xlx_offset_byte_param_w = 200*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_w)[j];
  ...
  __xlx_offset_byte_param_y = 400*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_y)[j];
  ...
  __xlx_offset_byte_param_b = 600*4;
...
conv_fwd_hw_stub_wrapper(__xlx_apatb_param_x, __xlx_apatb_param_w, __xlx_apatb_param_y, __xlx_apatb_param_b, __xlx_apatb_param_F, __xlx_apatb_param_C, __xlx_apatb_param_H, __xlx_apatb_param_W, __xlx_apatb_param_FH, __xlx_apatb_param_FW);
