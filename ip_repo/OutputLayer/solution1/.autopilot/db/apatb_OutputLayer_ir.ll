...
define void @apatb_OutputLayer_ir(%struct.ap_fixed* %y, %struct.ap_fixed* %dy, %struct.ap_fixed* %bram_y, %struct.ap_fixed* %bram_dy, i32 %dim, i1 %ddrtobram) local_unnamed_addr #1 {
entry:
