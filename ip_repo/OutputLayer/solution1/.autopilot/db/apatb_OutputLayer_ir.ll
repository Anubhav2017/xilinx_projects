; ModuleID = '/home/anubhav/xilinx_projects/ip_repo/OutputLayer/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_OutputLayer_ir(%struct.ap_fixed* %y, %struct.ap_fixed* %dy, %struct.ap_fixed* %bram_y, %struct.ap_fixed* %bram_dy, i32 %dim, i1 %ddrtobram) local_unnamed_addr #0 {
entry:
  %y_copy1 = alloca %struct.ap_fixed, align 512
  %dy_copy2 = alloca %struct.ap_fixed, align 512
  %bram_y_copy = alloca [1000 x %struct.ap_fixed], align 512
  %bram_dy_copy = alloca [1000 x %struct.ap_fixed], align 512
  %0 = bitcast %struct.ap_fixed* %bram_y to [1000 x %struct.ap_fixed]*
  %1 = bitcast %struct.ap_fixed* %bram_dy to [1000 x %struct.ap_fixed]*
  call fastcc void @copy_in(%struct.ap_fixed* %y, %struct.ap_fixed* nonnull align 512 %y_copy1, %struct.ap_fixed* %dy, %struct.ap_fixed* nonnull align 512 %dy_copy2, [1000 x %struct.ap_fixed]* %0, [1000 x %struct.ap_fixed]* nonnull align 512 %bram_y_copy, [1000 x %struct.ap_fixed]* %1, [1000 x %struct.ap_fixed]* nonnull align 512 %bram_dy_copy)
  %2 = getelementptr inbounds [1000 x %struct.ap_fixed], [1000 x %struct.ap_fixed]* %bram_y_copy, i32 0, i32 0
  %3 = getelementptr inbounds [1000 x %struct.ap_fixed], [1000 x %struct.ap_fixed]* %bram_dy_copy, i32 0, i32 0
  call void @apatb_OutputLayer_hw(%struct.ap_fixed* %y_copy1, %struct.ap_fixed* %dy_copy2, %struct.ap_fixed* %2, %struct.ap_fixed* %3, i32 %dim, i1 %ddrtobram)
  call fastcc void @copy_out(%struct.ap_fixed* %y, %struct.ap_fixed* nonnull align 512 %y_copy1, %struct.ap_fixed* %dy, %struct.ap_fixed* nonnull align 512 %dy_copy2, [1000 x %struct.ap_fixed]* %0, [1000 x %struct.ap_fixed]* nonnull align 512 %bram_y_copy, [1000 x %struct.ap_fixed]* %1, [1000 x %struct.ap_fixed]* nonnull align 512 %bram_dy_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%struct.ap_fixed*, %struct.ap_fixed* noalias align 512, %struct.ap_fixed*, %struct.ap_fixed* noalias align 512, [1000 x %struct.ap_fixed]*, [1000 x %struct.ap_fixed]* noalias align 512, [1000 x %struct.ap_fixed]*, [1000 x %struct.ap_fixed]* noalias align 512) unnamed_addr #1 {
entry:
...
declare void @apatb_OutputLayer_hw(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32, i1)

define void @OutputLayer_hw_stub_wrapper(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32, i1) #6 {
entry:
  ...
  call void @OutputLayer_hw_stub(%struct.ap_fixed* %0, %struct.ap_fixed* %1, %struct.ap_fixed* %8, %struct.ap_fixed* %9, i32 %4, i1 %5)
...
declare void @OutputLayer_hw_stub(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32, i1)
