...
# 3 "OutputLayer/main.cpp" 2
typedef ap_fixed<16,9> fixed_t;


__attribute__((sdx_kernel("OutputLayer", 0))) void OutputLayer(fixed_t* y,fixed_t* dy, fixed_t bram_y[1000], fixed_t bram_dy[1000], int dim, bool ddrtobram){_ssdm_SpecArrayDimSize(bram_y, 1000);_ssdm_SpecArrayDimSize(bram_dy, 1000);
#pragma HLS TOP name=OutputLayer
# 6 "OutputLayer/main.cpp"
