...
entity OutputLayer_CTRL_s_axi is
generic (
...
end entity OutputLayer_CTRL_s_axi;
...
architecture behave of OutputLayer_CTRL_s_axi is
    ...
    constant ADDR_DY_DATA_0        : INTEGER := 16#18#;
    constant ADDR_DY_CTRL          : INTEGER := 16#1c#;
    constant ADDR_DIM_DATA_0       : INTEGER := 16#20#;
    constant ADDR_DIM_CTRL         : INTEGER := 16#24#;
    constant ADDR_DDRTOBRAM_DATA_0 : INTEGER := 16#28#;
    constant ADDR_DDRTOBRAM_CTRL   : INTEGER := 16#2c#;
