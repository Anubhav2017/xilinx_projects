...
entity activation_fwd_CTRL_s_axi is
generic (
...
end entity activation_fwd_CTRL_s_axi;
...
-- 0x24 : reserved
-- 0x28 : Data signal of dimension
--        bit 31~0 - dimension[31:0] (Read/Write)
-- 0x2c : reserved
-- 0x30 : Data signal of type_r
--        bit 31~0 - type_r[31:0] (Read/Write)
-- 0x34 : reserved
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of activation_fwd_CTRL_s_axi is
    ...
    constant ADDR_DIMENSION_DATA_0 : INTEGER := 16#28#;
    constant ADDR_DIMENSION_CTRL   : INTEGER := 16#2c#;
    constant ADDR_TYPE_R_DATA_0    : INTEGER := 16#30#;
    constant ADDR_TYPE_R_CTRL      : INTEGER := 16#34#;
