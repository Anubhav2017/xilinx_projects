...
// wrapc file define:
#define AUTOTB_TVIN_b "../tv/cdatafile/c.backward_fcc.autotvin_b.dat"
#define AUTOTB_TVOUT_b "../tv/cdatafile/c.backward_fcc.autotvout_b.dat"
// wrapc file define:
...
// wrapc file define:
#define AUTOTB_TVIN_xdimension "../tv/cdatafile/c.backward_fcc.autotvin_xdimension.dat"
#define AUTOTB_TVOUT_xdimension "../tv/cdatafile/c.backward_fcc.autotvout_xdimension.dat"
// wrapc file define:
#define AUTOTB_TVIN_ydimension "../tv/cdatafile/c.backward_fcc.autotvin_ydimension.dat"
#define AUTOTB_TVOUT_ydimension "../tv/cdatafile/c.backward_fcc.autotvout_ydimension.dat"
// wrapc file define:
#define AUTOTB_TVIN_lr "../tv/cdatafile/c.backward_fcc.autotvin_lr.dat"
#define AUTOTB_TVOUT_lr "../tv/cdatafile/c.backward_fcc.autotvout_lr.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_b "../tv/rtldatafile/rtl.backward_fcc.autotvout_b.dat"
// tvout file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_xdimension "../tv/rtldatafile/rtl.backward_fcc.autotvout_xdimension.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_ydimension "../tv/rtldatafile/rtl.backward_fcc.autotvout_ydimension.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_lr "../tv/rtldatafile/rtl.backward_fcc.autotvout_lr.dat"
...
extern "C" void backward_fcc_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, int, int, float);

extern "C" void apatb_backward_fcc_hw(volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_w, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_dx, volatile void * __xlx_apatb_param_dy, int __xlx_apatb_param_xdimension, int __xlx_apatb_param_ydimension, float __xlx_apatb_param_lr) {
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > gmem_pc_buffer(500);
          int i = 0;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_x)[j];
  ...
  __xlx_offset_byte_param_w = 100*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_w)[j];
  ...
  __xlx_offset_byte_param_b = 200*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_b)[j];
  ...
  __xlx_offset_byte_param_dx = 300*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_dy)[j];
  ...
  tcl_file.set_num(500, &tcl_file.gmem_depth);
...
// print lr Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_lr);
...
backward_fcc_hw_stub_wrapper(__xlx_apatb_param_x, __xlx_apatb_param_w, __xlx_apatb_param_b, __xlx_apatb_param_dx, __xlx_apatb_param_dy, __xlx_apatb_param_xdimension, __xlx_apatb_param_ydimension, __xlx_apatb_param_lr);
