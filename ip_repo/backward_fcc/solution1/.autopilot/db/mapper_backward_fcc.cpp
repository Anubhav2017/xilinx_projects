...
extern "C" void backward_fcc(short*, int, int, int, int, int, int, int, int);
extern "C" void apatb_backward_fcc_hw(volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_w, volatile void * __xlx_apatb_param_dx, volatile void * __xlx_apatb_param_dy, volatile void * __xlx_apatb_param_dw, volatile void * __xlx_apatb_param_db, int __xlx_apatb_param_xdim, int __xlx_apatb_param_ydim) {
  ...
  vector<sc_bv<16> >__xlx_x_w_dx_dy_dw_db__tmp_vec;
  for (int j = 0, e = 100; j != e; ++j) {
    __xlx_x_w_dx_dy_dw_db__tmp_vec.push_back(((short*)__xlx_apatb_param_x)[j]);
  }
  int __xlx_size_param_x = 100;
  int __xlx_offset_param_x = 0;
  int __xlx_offset_byte_param_x = 0*2;
  for (int j = 0, e = 100; j != e; ++j) {
    __xlx_x_w_dx_dy_dw_db__tmp_vec.push_back(((short*)__xlx_apatb_param_w)[j]);
  }
  int __xlx_size_param_w = 100;
  int __xlx_offset_param_w = 100;
  int __xlx_offset_byte_param_w = 100*2;
  for (int j = 0, e = 100; j != e; ++j) {
    __xlx_x_w_dx_dy_dw_db__tmp_vec.push_back(((short*)__xlx_apatb_param_dx)[j]);
  }
  int __xlx_size_param_dx = 100;
  int __xlx_offset_param_dx = 200;
  int __xlx_offset_byte_param_dx = 200*2;
  for (int j = 0, e = 100; j != e; ++j) {
    __xlx_x_w_dx_dy_dw_db__tmp_vec.push_back(((short*)__xlx_apatb_param_dy)[j]);
  }
  int __xlx_size_param_dy = 100;
  int __xlx_offset_param_dy = 300;
  int __xlx_offset_byte_param_dy = 300*2;
  for (int j = 0, e = 100; j != e; ++j) {
    __xlx_x_w_dx_dy_dw_db__tmp_vec.push_back(((short*)__xlx_apatb_param_dw)[j]);
  }
  int __xlx_size_param_dw = 100;
  int __xlx_offset_param_dw = 400;
  int __xlx_offset_byte_param_dw = 400*2;
  for (int j = 0, e = 100; j != e; ++j) {
    __xlx_x_w_dx_dy_dw_db__tmp_vec.push_back(((short*)__xlx_apatb_param_db)[j]);
  }
  int __xlx_size_param_db = 100;
  int __xlx_offset_param_db = 500;
  int __xlx_offset_byte_param_db = 500*2;
  short* __xlx_x_w_dx_dy_dw_db__input_buffer= new short[__xlx_x_w_dx_dy_dw_db__tmp_vec.size()];
  for (int i = 0; i < __xlx_x_w_dx_dy_dw_db__tmp_vec.size(); ++i) {
    __xlx_x_w_dx_dy_dw_db__input_buffer[i] = __xlx_x_w_dx_dy_dw_db__tmp_vec[i].range(15, 0).to_uint64();
  }
  // DUT call
