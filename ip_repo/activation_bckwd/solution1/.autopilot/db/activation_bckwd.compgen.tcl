...
set id 1
set name activation_bckwd_fcmp_32ns_32ns_1_2_no_dsp_1
...
set ID 4
set hasByteEnable 0
set MemName activation_bckwd_x_t
...
set ID 5
set hasByteEnable 0
set MemName activation_bckwd_dx_t
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 32
set AddrRange 100
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 6 \
			corename activation_bckwd_CTRL_axilite \
			name activation_bckwd_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler activation_bckwd_CTRL_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    delay_budget 7.3 \ 
    is_flushable 0 \ 
    name {activation_bckwd_gmem_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler activation_bckwd_gmem_m_axi
}
