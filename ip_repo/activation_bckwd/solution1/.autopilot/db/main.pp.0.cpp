...
# 3 "activation_bckwd/main.cpp" 2



__attribute__((sdx_kernel("activation_bckwd", 0))) void activation_bckwd(volatile float* x,volatile float* dx,volatile float* dy, int dimension, int type){
#pragma HLS TOP name=activation_bckwd
# 6 "activation_bckwd/main.cpp"
...
#pragma HLS UNROLL factor=5
 if(x_t[i] > 0){
     ...
     VITIS_LOOP_46_2: for(int i=0;i<dim;i++){
#pragma HLS UNROLL factor=5
 dx_t[i] = dy_t[i];
     }
