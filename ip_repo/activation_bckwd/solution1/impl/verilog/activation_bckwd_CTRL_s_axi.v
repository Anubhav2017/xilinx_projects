...
// ==============================================================
`timescale 1ns/1ps
module activation_bckwd_CTRL_s_axi
#(parameter
...
localparam
    ...
    ADDR_X_DATA_1         = 7'h14,
    ADDR_X_CTRL           = 7'h18,
    ADDR_DX_DATA_0        = 7'h1c,
    ADDR_DX_DATA_1        = 7'h20,
    ADDR_DX_CTRL          = 7'h24,
    ADDR_DY_DATA_0        = 7'h28,
    ADDR_DY_DATA_1        = 7'h2c,
    ADDR_DY_CTRL          = 7'h30,
    ADDR_DIMENSION_DATA_0 = 7'h34,
    ADDR_DIMENSION_CTRL   = 7'h38,
    ADDR_TYPE_R_DATA_0    = 7'h3c,
    ADDR_TYPE_R_CTRL      = 7'h40,
    WRIDLE                = 2'd0,
    WRDATA                = 2'd1,
    WRRESP                = 2'd2,
    WRRESET               = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_DIMENSION_DATA_0: begin
                    rdata <= int_dimension[31:0];
                end
...
assign dx        = int_dx;
assign dy        = int_dy;
assign dimension = int_dimension;
...
always @(posedge ACLK) begin
    if (ARESET)
        int_dimension[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_DIMENSION_DATA_0)
            int_dimension[31:0] <= (WDATA[31:0] & wmask) | (int_dimension[31:0] & ~wmask);
    end
end
