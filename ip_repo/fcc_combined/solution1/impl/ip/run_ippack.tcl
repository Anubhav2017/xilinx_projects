...
set hdl_module_list {fcc_combined_mul_31s_31s_31_2_1
...
set Interfaces {
    ...
    s_axi_control {
        ...
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{0x10 w W 0x0 "Data signal of w" {{0 32 w W 0 "Bit 31 to 0 of w"}}} {0x18 dw W 0x0 "Data signal of dw" {{0 32 dw W 0 "Bit 31 to 0 of dw"}}} {0x20 b W 0x0 "Data signal of b" {{0 32 b W 0 "Bit 31 to 0 of b"}}} {0x28 db W 0x0 "Data signal of db" {{0 32 db W 0 "Bit 31 to 0 of db"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CRTL_BUS s_axi_control m_axi_gmem"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
