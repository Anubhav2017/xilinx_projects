...
architecture behave of fcc_combined_control_s_axi is
    ...
    constant ADDR_DEBUGIP_DATA_0  : INTEGER := 16#40#;
    constant ADDR_DEBUGIP_CTRL    : INTEGER := 16#44#;
    constant ADDR_XDIM_DATA_0     : INTEGER := 16#48#;
    constant ADDR_XDIM_CTRL       : INTEGER := 16#4c#;
    constant ADDR_YDIM_DATA_0     : INTEGER := 16#50#;
    constant ADDR_YDIM_CTRL       : INTEGER := 16#54#;
    constant ADDR_FWPROP_DATA_0   : INTEGER := 16#58#;
    constant ADDR_FWPROP_CTRL     : INTEGER := 16#5c#;
