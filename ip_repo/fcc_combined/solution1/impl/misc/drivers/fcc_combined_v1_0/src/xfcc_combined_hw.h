...
#define XFCC_COMBINED_CRTL_BUS_ADDR_W_DATA      0x10
#define XFCC_COMBINED_CRTL_BUS_BITS_W_DATA      32
#define XFCC_COMBINED_CRTL_BUS_ADDR_DW_DATA     0x18
#define XFCC_COMBINED_CRTL_BUS_BITS_DW_DATA     32
