...
set id 1
set name fcc_combined_mul_32s_34ns_65_2_1
...
set id 2
set name fcc_combined_mul_31s_7ns_31_2_1
set corename simcore_mul
set op mul
set stage_num 2
set max_latency -1
...
set out_width 16
set exp i0*i1+i2
set arg_lists {i0 {10 0 +} i1 {11 0 +} m {16 0 +} i2 {16 0 +} p {16 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
