...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "wt","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "wt","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "dwt","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "dwt","bundle": "control"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "b","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "b","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "db","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "db","bundle": "control"},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "debugip", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "debugip","cData": "int1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":64}, "offset_end" : {"in":71}} , 
 	{ "Name" : "xdim", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "xdim","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":72}, "offset_end" : {"in":79}} , 
 	{ "Name" : "ydim", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "ydim","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":80}, "offset_end" : {"in":87}} , 
 	{ "Name" : "fwprop", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "fwprop","cData": "int1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":88}, "offset_end" : {"in":95}} ]}
...
set portList { 
	...
	{ y_WEN_A sc_out sc_lv 2 signal 8 } 
	{ y_Din_A sc_out sc_lv 16 signal 8 } 
	{ y_Dout_A sc_in sc_lv 16 signal 8 } 
	{ y_Clk_A sc_out sc_logic 1 signal 8 } 
	{ y_Rst_A sc_out sc_logic 1 signal 8 } 
	{ dy_Addr_A sc_out sc_lv 32 signal 9 } 
	{ dy_EN_A sc_out sc_logic 1 signal 9 } 
	{ dy_WEN_A sc_out sc_lv 2 signal 9 } 
	{ dy_Din_A sc_out sc_lv 16 signal 9 } 
	{ dy_Dout_A sc_in sc_lv 16 signal 9 } 
	{ dy_Clk_A sc_out sc_logic 1 signal 9 } 
	{ dy_Rst_A sc_out sc_logic 1 signal 9 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"fcc_combined","role":"start","value":"0","valid_bit":"0"},{"name":"fcc_combined","role":"continue","value":"0","valid_bit":"4"},{"name":"fcc_combined","role":"auto_start","value":"0","valid_bit":"7"},{"name":"wt","role":"data","value":"16"},{"name":"dwt","role":"data","value":"24"},{"name":"b","role":"data","value":"32"},{"name":"db","role":"data","value":"40"},{"name":"debug_x","role":"data","value":"48"},{"name":"debug_dx","role":"data","value":"56"},{"name":"debugip","role":"data","value":"64"},{"name":"xdim","role":"data","value":"72"},{"name":"ydim","role":"data","value":"80"},{"name":"fwprop","role":"data","value":"88"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"fcc_combined","role":"start","value":"0","valid_bit":"0"},{"name":"fcc_combined","role":"done","value":"0","valid_bit":"1"},{"name":"fcc_combined","role":"idle","value":"0","valid_bit":"2"},{"name":"fcc_combined","role":"ready","value":"0","valid_bit":"3"},{"name":"fcc_combined","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dwbuf_V_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dbbuf_V_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_26s_26s_26_1_1_U1", "Parent" : "0"},
	...
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64ns_32ns_96_5_1_U4", "Parent" : "0"},
	...
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_5ns_11ns_15_4_1_U7", "Parent" : "0"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_10ns_11ns_15ns_15_4_1_U8", "Parent" : "0"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_29ns_29_4_1_U9", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_29ns_29_4_1_U10", "Parent" : "0"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_5ns_11ns_15_4_1_U11", "Parent" : "0"},
	{"ID" : "19", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_5ns_11ns_15_4_1_U12", "Parent" : "0"},
	{"ID" : "20", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_10ns_11ns_15_4_1_U13", "Parent" : "0"},
	{"ID" : "21", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_29ns_29_4_1_U14", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	fcc_combined {
		gmem {Type IO LastRead 28 FirstWrite 29}
		gmem2 {Type O LastRead 18 FirstWrite 16}
		x {Type I LastRead 19 FirstWrite -1}
		dx {Type IO LastRead 21 FirstWrite 11}
		...
		dy {Type I LastRead 21 FirstWrite -1}
