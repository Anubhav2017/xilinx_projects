...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "w","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "w","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "dw","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "dw","bundle": "control"},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "b","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "b","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "db","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "db","bundle": "control"},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "dx", "interface" : "bram", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "dx","cData": "short","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	{ "Name" : "w", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "dw", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	...
 	{ "Name" : "xdim", "interface" : "axi_slave", "bundle":"CRTL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "xdim","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "ydim", "interface" : "axi_slave", "bundle":"CRTL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "ydim","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	{ "Name" : "fwprop", "interface" : "axi_slave", "bundle":"CRTL_BUS","type":"ap_none","bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "fwprop","cData": "int1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":32}, "offset_end" : {"in":39}} ]}
...
set portList { 
	...
	{ y_Addr_A sc_out sc_lv 32 signal 7 } 
	{ y_EN_A sc_out sc_logic 1 signal 7 } 
	{ y_WEN_A sc_out sc_lv 2 signal 7 } 
	{ y_Din_A sc_out sc_lv 16 signal 7 } 
	{ y_Dout_A sc_in sc_lv 16 signal 7 } 
	{ y_Clk_A sc_out sc_logic 1 signal 7 } 
	{ y_Rst_A sc_out sc_logic 1 signal 7 } 
	{ dy_Addr_A sc_out sc_lv 32 signal 8 } 
	{ dy_EN_A sc_out sc_logic 1 signal 8 } 
	{ dy_WEN_A sc_out sc_lv 2 signal 8 } 
	{ dy_Din_A sc_out sc_lv 16 signal 8 } 
	{ dy_Dout_A sc_in sc_lv 16 signal 8 } 
	{ dy_Clk_A sc_out sc_logic 1 signal 8 } 
	{ dy_Rst_A sc_out sc_logic 1 signal 8 } 
...
set NewPortList {[ 
	{ "name": "s_axi_CRTL_BUS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CRTL_BUS", "role": "AWADDR" },"address":[{"name":"fcc_combined","role":"start","value":"0","valid_bit":"0"},{"name":"fcc_combined","role":"continue","value":"0","valid_bit":"4"},{"name":"fcc_combined","role":"auto_start","value":"0","valid_bit":"7"},{"name":"xdim","role":"data","value":"16"},{"name":"ydim","role":"data","value":"24"},{"name":"fwprop","role":"data","value":"32"}] },
	...
	{ "name": "s_axi_CRTL_BUS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CRTL_BUS", "role": "ARADDR" },"address":[{"name":"fcc_combined","role":"start","value":"0","valid_bit":"0"},{"name":"fcc_combined","role":"done","value":"0","valid_bit":"1"},{"name":"fcc_combined","role":"idle","value":"0","valid_bit":"2"},{"name":"fcc_combined","role":"ready","value":"0","valid_bit":"3"},{"name":"fcc_combined","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"w","role":"data","value":"16"},{"name":"dw","role":"data","value":"24"},{"name":"b","role":"data","value":"32"},{"name":"db","role":"data","value":"40"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_31s_31s_31_2_1_U1", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_31ns_32ns_63_2_1_U2", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_10ns_11ns_20_4_1_U3", "Parent" : "0"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_10ns_11ns_20ns_20_4_1_U4", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_23ns_23_4_1_U5", "Parent" : "0"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_16s_16s_23_4_1_U6", "Parent" : "0"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_10ns_11ns_20_4_1_U7", "Parent" : "0"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_23ns_23_4_1_U8", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	fcc_combined {
		...
		dx {Type O LastRead -1 FirstWrite 19}
		w {Type I LastRead 0 FirstWrite -1}
		dw {Type I LastRead -1 FirstWrite -1}
		b {Type I LastRead 0 FirstWrite -1}
		db {Type I LastRead -1 FirstWrite -1}
		y {Type O LastRead -1 FirstWrite 19}
		dy {Type I LastRead 14 FirstWrite -1}
