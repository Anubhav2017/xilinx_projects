...
void XFcc_combined_Set_debug_x(XFcc_combined *InstancePtr, u32 Data) {
    ...
    XFcc_combined_WriteReg(InstancePtr->Control_BaseAddress, XFCC_COMBINED_CONTROL_ADDR_DEBUG_X_DATA, Data);
}
...
u32 XFcc_combined_Get_debug_x(XFcc_combined *InstancePtr) {
    ...
    Data = XFcc_combined_ReadReg(InstancePtr->Control_BaseAddress, XFCC_COMBINED_CONTROL_ADDR_DEBUG_X_DATA);
    return Data;
}
...
void XFcc_combined_Set_debug_dx(XFcc_combined *InstancePtr, u32 Data) {
    ...
    XFcc_combined_WriteReg(InstancePtr->Control_BaseAddress, XFCC_COMBINED_CONTROL_ADDR_DEBUG_DX_DATA, Data);
}
...
u32 XFcc_combined_Get_debug_dx(XFcc_combined *InstancePtr) {
    ...
    Data = XFcc_combined_ReadReg(InstancePtr->Control_BaseAddress, XFCC_COMBINED_CONTROL_ADDR_DEBUG_DX_DATA);
    return Data;
}
...
void XFcc_combined_Set_debugip(XFcc_combined *InstancePtr, u32 Data) {
    ...
    XFcc_combined_WriteReg(InstancePtr->Control_BaseAddress, XFCC_COMBINED_CONTROL_ADDR_DEBUGIP_DATA, Data);
}
...
u32 XFcc_combined_Get_debugip(XFcc_combined *InstancePtr) {
    ...
    Data = XFcc_combined_ReadReg(InstancePtr->Control_BaseAddress, XFCC_COMBINED_CONTROL_ADDR_DEBUGIP_DATA);
    return Data;
}
