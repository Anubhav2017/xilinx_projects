...
define void @apatb_fcc_combined_ir(%struct.ap_fixed* %x, %struct.ap_fixed* %dx, %struct.ap_fixed* %w, %struct.ap_fixed* %dw, %struct.ap_fixed* %b, %struct.ap_fixed* %db, %struct.ap_fixed* %y, %struct.ap_fixed* %dy, i32 %xdim, i32 %ydim, i1 %fwprop) local_unnamed_addr #0 {
entry:
  ...
  %2 = bitcast %struct.ap_fixed* %w to [200 x %struct.ap_fixed]*
  %3 = bitcast %struct.ap_fixed* %dw to [200 x %struct.ap_fixed]*
  %4 = bitcast %struct.ap_fixed* %b to [200 x %struct.ap_fixed]*
  %5 = bitcast %struct.ap_fixed* %db to [200 x %struct.ap_fixed]*
  %6 = bitcast %struct.ap_fixed* %y to [1000 x %struct.ap_fixed]*
  %7 = bitcast %struct.ap_fixed* %dy to [1000 x %struct.ap_fixed]*
  call fastcc void @copy_in([1000 x %struct.ap_fixed]* %0, [1000 x %struct.ap_fixed]* nonnull align 512 %x_copy, [1000 x %struct.ap_fixed]* %1, [1000 x %struct.ap_fixed]* nonnull align 512 %dx_copy, [200 x %struct.ap_fixed]* %2, [200 x %struct.ap_fixed]* nonnull align 512 %w_copy, [200 x %struct.ap_fixed]* %3, [200 x %struct.ap_fixed]* nonnull align 512 %dw_copy, [200 x %struct.ap_fixed]* %4, [200 x %struct.ap_fixed]* nonnull align 512 %b_copy, [200 x %struct.ap_fixed]* %5, [200 x %struct.ap_fixed]* nonnull align 512 %db_copy, [1000 x %struct.ap_fixed]* %6, [1000 x %struct.ap_fixed]* nonnull align 512 %y_copy, [1000 x %struct.ap_fixed]* %7, [1000 x %struct.ap_fixed]* nonnull align 512 %dy_copy)
  ...
  %10 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %w_copy, i32 0, i32 0
  %11 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %dw_copy, i32 0, i32 0
  %12 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %b_copy, i32 0, i32 0
  %13 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %db_copy, i32 0, i32 0
  ...
  call void @apatb_fcc_combined_hw(%struct.ap_fixed* %8, %struct.ap_fixed* %9, %struct.ap_fixed* %10, %struct.ap_fixed* %11, %struct.ap_fixed* %12, %struct.ap_fixed* %13, %struct.ap_fixed* %14, %struct.ap_fixed* %15, i32 %xdim, i32 %ydim, i1 %fwprop)
  call fastcc void @copy_out([1000 x %struct.ap_fixed]* %0, [1000 x %struct.ap_fixed]* nonnull align 512 %x_copy, [1000 x %struct.ap_fixed]* %1, [1000 x %struct.ap_fixed]* nonnull align 512 %dx_copy, [200 x %struct.ap_fixed]* %2, [200 x %struct.ap_fixed]* nonnull align 512 %w_copy, [200 x %struct.ap_fixed]* %3, [200 x %struct.ap_fixed]* nonnull align 512 %dw_copy, [200 x %struct.ap_fixed]* %4, [200 x %struct.ap_fixed]* nonnull align 512 %b_copy, [200 x %struct.ap_fixed]* %5, [200 x %struct.ap_fixed]* nonnull align 512 %db_copy, [1000 x %struct.ap_fixed]* %6, [1000 x %struct.ap_fixed]* nonnull align 512 %y_copy, [1000 x %struct.ap_fixed]* %7, [1000 x %struct.ap_fixed]* nonnull align 512 %dy_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in([1000 x %struct.ap_fixed]*, [1000 x %struct.ap_fixed]* noalias align 512, [1000 x %struct.ap_fixed]*, [1000 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [1000 x %struct.ap_fixed]*, [1000 x %struct.ap_fixed]* noalias align 512, [1000 x %struct.ap_fixed]*, [1000 x %struct.ap_fixed]* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([1000 x %struct.ap_fixed]*, [1000 x %struct.ap_fixed]* noalias align 512, [1000 x %struct.ap_fixed]*, [1000 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [1000 x %struct.ap_fixed]*, [1000 x %struct.ap_fixed]* noalias align 512, [1000 x %struct.ap_fixed]*, [1000 x %struct.ap_fixed]* noalias align 512) unnamed_addr #5 {
entry:
...
entry:
  %11 = bitcast %struct.ap_fixed* %0 to [1000 x %struct.ap_fixed]*
  %12 = bitcast %struct.ap_fixed* %1 to [1000 x %struct.ap_fixed]*
  %13 = bitcast %struct.ap_fixed* %2 to [200 x %struct.ap_fixed]*
  %14 = bitcast %struct.ap_fixed* %3 to [200 x %struct.ap_fixed]*
  %15 = bitcast %struct.ap_fixed* %4 to [200 x %struct.ap_fixed]*
  %16 = bitcast %struct.ap_fixed* %5 to [200 x %struct.ap_fixed]*
  %17 = bitcast %struct.ap_fixed* %6 to [1000 x %struct.ap_fixed]*
  %18 = bitcast %struct.ap_fixed* %7 to [1000 x %struct.ap_fixed]*
  call void @copy_out([1000 x %struct.ap_fixed]* null, [1000 x %struct.ap_fixed]* %11, [1000 x %struct.ap_fixed]* null, [1000 x %struct.ap_fixed]* %12, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %13, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %14, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %15, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %16, [1000 x %struct.ap_fixed]* null, [1000 x %struct.ap_fixed]* %17, [1000 x %struct.ap_fixed]* null, [1000 x %struct.ap_fixed]* %18)
  %19 = bitcast [1000 x %struct.ap_fixed]* %11 to %struct.ap_fixed*
  %20 = bitcast [1000 x %struct.ap_fixed]* %12 to %struct.ap_fixed*
  %21 = bitcast [200 x %struct.ap_fixed]* %13 to %struct.ap_fixed*
  %22 = bitcast [200 x %struct.ap_fixed]* %14 to %struct.ap_fixed*
  %23 = bitcast [200 x %struct.ap_fixed]* %15 to %struct.ap_fixed*
  %24 = bitcast [200 x %struct.ap_fixed]* %16 to %struct.ap_fixed*
  %25 = bitcast [1000 x %struct.ap_fixed]* %17 to %struct.ap_fixed*
  %26 = bitcast [1000 x %struct.ap_fixed]* %18 to %struct.ap_fixed*
  call void @fcc_combined_hw_stub(%struct.ap_fixed* %19, %struct.ap_fixed* %20, %struct.ap_fixed* %21, %struct.ap_fixed* %22, %struct.ap_fixed* %23, %struct.ap_fixed* %24, %struct.ap_fixed* %25, %struct.ap_fixed* %26, i32 %8, i32 %9, i1 %10)
  call void @copy_in([1000 x %struct.ap_fixed]* null, [1000 x %struct.ap_fixed]* %11, [1000 x %struct.ap_fixed]* null, [1000 x %struct.ap_fixed]* %12, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %13, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %14, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %15, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %16, [1000 x %struct.ap_fixed]* null, [1000 x %struct.ap_fixed]* %17, [1000 x %struct.ap_fixed]* null, [1000 x %struct.ap_fixed]* %18)
  ret void
}
