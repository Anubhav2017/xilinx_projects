...
define internal fastcc void @copy_in([200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512) unnamed_addr #4 {
entry:
...
declare void @apatb_loss_derivative_hw(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32, i32, i32)

define void @loss_derivative_hw_stub_wrapper(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32, i32, i32) #5 {
entry:
  %6 = bitcast %struct.ap_fixed* %1 to [200 x %struct.ap_fixed]*
  %7 = bitcast %struct.ap_fixed* %2 to [200 x %struct.ap_fixed]*
  call void @copy_out([200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %6, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %7)
  %8 = bitcast [200 x %struct.ap_fixed]* %6 to %struct.ap_fixed*
  %9 = bitcast [200 x %struct.ap_fixed]* %7 to %struct.ap_fixed*
  call void @loss_derivative_hw_stub(%struct.ap_fixed* %0, %struct.ap_fixed* %8, %struct.ap_fixed* %9, i32 %3, i32 %4, i32 %5)
  call void @copy_in([200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %6, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %7)
  ret void
}

declare void @loss_derivative_hw_stub(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32, i32, i32)

; Function Attrs: noinline
define void @apatb_loss_derivative_ir(i16* %ret, %struct.ap_fixed* %x, %struct.ap_fixed* %dx, i32 %y, i32 %x_size, i32 %N) #6 {
entry:
  ...
  call fastcc void @copy_in([200 x %struct.ap_fixed]* %0, [200 x %struct.ap_fixed]* nonnull align 512 %x_copy, [200 x %struct.ap_fixed]* %1, [200 x %struct.ap_fixed]* nonnull align 512 %dx_copy)
  %2 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %x_copy, i32 0, i32 0
  %3 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %dx_copy, i32 0, i32 0
  %4 = alloca %struct.ap_fixed
  call void @apatb_loss_derivative_hw(%struct.ap_fixed* %4, %struct.ap_fixed* %2, %struct.ap_fixed* %3, i32 %y, i32 %x_size, i32 %N)
  %5 = load volatile %struct.ap_fixed, %struct.ap_fixed* %4
  call fastcc void @copy_out([200 x %struct.ap_fixed]* %0, [200 x %struct.ap_fixed]* nonnull align 512 %x_copy, [200 x %struct.ap_fixed]* %1, [200 x %struct.ap_fixed]* nonnull align 512 %dx_copy)
