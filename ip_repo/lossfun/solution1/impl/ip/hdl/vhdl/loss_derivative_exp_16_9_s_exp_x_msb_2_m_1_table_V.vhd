...
entity loss_derivative_exp_16_9_s_exp_x_msb_2_m_1_table_V_rom is 
    generic(
             DWIDTH     : integer := 25; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of loss_derivative_exp_16_9_s_exp_x_msb_2_m_1_table_V_rom is 
...
entity loss_derivative_exp_16_9_s_exp_x_msb_2_m_1_table_V is
    generic (
...
architecture arch of loss_derivative_exp_16_9_s_exp_x_msb_2_m_1_table_V is
    component loss_derivative_exp_16_9_s_exp_x_msb_2_m_1_table_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    loss_derivative_exp_16_9_s_exp_x_msb_2_m_1_table_V_rom_U :  component loss_derivative_exp_16_9_s_exp_x_msb_2_m_1_table_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
