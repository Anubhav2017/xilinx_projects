...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "debug_x","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "debug_x","bundle": "control"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "debug_dx","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "debug_dx","bundle": "control"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "debug_x", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "debug_dx", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	...
 	{ "Name" : "fwprop", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "fwprop","cData": "int1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":40}, "offset_end" : {"in":47}} , 
 	{ "Name" : "debugip", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "debugip","cData": "int1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":48}, "offset_end" : {"in":55}} ]}
...
set portList { 
	...
	{ y_Addr_A sc_out sc_lv 32 signal 3 } 
	{ y_EN_A sc_out sc_logic 1 signal 3 } 
	{ y_WEN_A sc_out sc_lv 2 signal 3 } 
	{ y_Din_A sc_out sc_lv 16 signal 3 } 
	{ y_Dout_A sc_in sc_lv 16 signal 3 } 
	{ y_Clk_A sc_out sc_logic 1 signal 3 } 
	{ y_Rst_A sc_out sc_logic 1 signal 3 } 
	{ dy_Addr_A sc_out sc_lv 32 signal 4 } 
	{ dy_EN_A sc_out sc_logic 1 signal 4 } 
	{ dy_WEN_A sc_out sc_lv 2 signal 4 } 
	{ dy_Din_A sc_out sc_lv 16 signal 4 } 
	{ dy_Dout_A sc_in sc_lv 16 signal 4 } 
	{ dy_Clk_A sc_out sc_logic 1 signal 4 } 
	{ dy_Rst_A sc_out sc_logic 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"relu_combined","role":"start","value":"0","valid_bit":"0"},{"name":"relu_combined","role":"continue","value":"0","valid_bit":"4"},{"name":"relu_combined","role":"auto_start","value":"0","valid_bit":"7"},{"name":"debug_x","role":"data","value":"16"},{"name":"debug_dx","role":"data","value":"24"},{"name":"dim","role":"data","value":"32"},{"name":"fwprop","role":"data","value":"40"},{"name":"debugip","role":"data","value":"48"}] },
...
set ArgLastReadFirstWriteLatency {
	relu_combined {
		...
		dx {Type IO LastRead 3 FirstWrite 5}
		y {Type O LastRead -1 FirstWrite 4}
		dy {Type I LastRead 3 FirstWrite -1}
