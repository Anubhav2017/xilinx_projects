...
set Library     "hls"
set IPName      "relu_combined"
set Version     "1.0"
set DisplayName "Relu_combined"
set Revision    "2112519895"
...
set xo_kernel_name "relu_combined"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/anubhav/xilinx_projects/ip_repo/relu_combined/solution1"
set debug_dir "/home/anubhav/xilinx_projects/ip_repo/relu_combined/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {relu_combined_control_s_axi
...
## Variables
set Top "relu_combined"
set TopNoPrefix "relu_combined"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 debug_x W 0x0 "Data signal of debug_x" {{0 32 debug_x W 0 "Bit 31 to 0 of debug_x"}}} {0x18 debug_dx W 0x0 "Data signal of debug_dx" {{0 32 debug_dx W 0 "Bit 31 to 0 of debug_dx"}}} {0x20 dim W 0x0 "Data signal of dim" {{0 32 dim W 0 "Bit 31 to 0 of dim"}}} {0x28 fwprop W 0x0 "Data signal of fwprop" {{0 1 fwprop W 0 "Bit 0 to 0 of fwprop"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 debugip W 0x0 "Data signal of debugip" {{0 1 debugip W 0 "Bit 0 to 0 of debugip"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
