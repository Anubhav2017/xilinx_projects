...
set Library     "hls"
set IPName      "conv_combined"
set Version     "1.0"
set DisplayName "Conv_combined"
set Revision    "2112520717"
...
set xo_kernel_name "conv_combined"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/anubhav/xilinx_projects/ip_repo/conv_combined/solution1"
set debug_dir "/home/anubhav/xilinx_projects/ip_repo/conv_combined/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {conv_combined_mul_32ns_32ns_64_2_1
...
## Variables
set Top "conv_combined"
set TopNoPrefix "conv_combined"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 wt W 0x0 "Data signal of wt" {{0 32 wt W 0 "Bit 31 to 0 of wt"}}} {0x18 dwt W 0x0 "Data signal of dwt" {{0 32 dwt W 0 "Bit 31 to 0 of dwt"}}} {0x20 b W 0x0 "Data signal of b" {{0 32 b W 0 "Bit 31 to 0 of b"}}} {0x28 db W 0x0 "Data signal of db" {{0 32 db W 0 "Bit 31 to 0 of db"}}} {0x30 debug_x W 0x0 "Data signal of debug_x" {{0 32 debug_x W 0 "Bit 31 to 0 of debug_x"}}} {0x38 debug_dx W 0x0 "Data signal of debug_dx" {{0 32 debug_dx W 0 "Bit 31 to 0 of debug_dx"}}} {0x40 F W 0x0 "Data signal of F" {{0 32 F W 0 "Bit 31 to 0 of F"}}} {0x48 C W 0x0 "Data signal of C" {{0 32 C W 0 "Bit 31 to 0 of C"}}} {0x50 H W 0x0 "Data signal of H" {{0 32 H W 0 "Bit 31 to 0 of H"}}} {0x58 W W 0x0 "Data signal of W" {{0 32 W W 0 "Bit 31 to 0 of W"}}} {0x60 FH W 0x0 "Data signal of FH" {{0 32 FH W 0 "Bit 31 to 0 of FH"}}} {0x68 FW W 0x0 "Data signal of FW" {{0 32 FW W 0 "Bit 31 to 0 of FW"}}} {0x70 fwprop W 0x0 "Data signal of fwprop" {{0 1 fwprop W 0 "Bit 0 to 0 of fwprop"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 debugip W 0x0 "Data signal of debugip" {{0 1 debugip W 0 "Bit 0 to 0 of debugip"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
