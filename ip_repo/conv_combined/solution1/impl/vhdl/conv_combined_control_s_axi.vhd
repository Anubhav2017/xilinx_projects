...
architecture behave of conv_combined_control_s_axi is
    ...
    constant ADDR_DEBUG_X_DATA_0  : INTEGER := 16#30#;
    constant ADDR_DEBUG_X_CTRL    : INTEGER := 16#34#;
    constant ADDR_DEBUG_DX_DATA_0 : INTEGER := 16#38#;
    constant ADDR_DEBUG_DX_CTRL   : INTEGER := 16#3c#;
    ...
    constant ADDR_W_DATA_0        : INTEGER := 16#58#;
    constant ADDR_W_CTRL          : INTEGER := 16#5c#;
    ...
    constant ADDR_FWPROP_DATA_0   : INTEGER := 16#70#;
    constant ADDR_FWPROP_CTRL     : INTEGER := 16#74#;
    constant ADDR_DEBUGIP_DATA_0  : INTEGER := 16#78#;
    constant ADDR_DEBUGIP_CTRL    : INTEGER := 16#7c#;
