...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("x_Addr_A", 32, hls_out, 1, "bram", "MemPortADDR2", 1),
	Port_Property("x_EN_A", 1, hls_out, 1, "bram", "MemPortCE2", 1),
	Port_Property("x_WEN_A", 4, hls_out, 1, "bram", "MemPortWE2", 1),
	Port_Property("x_Din_A", 32, hls_out, 1, "bram", "MemPortDIN2", 1),
	Port_Property("x_Dout_A", 32, hls_in, 1, "bram", "MemPortDOUT2", 1),
	Port_Property("x_Clk_A", 1, hls_out, 1, "bram", "mem_clk", 1),
	Port_Property("x_Rst_A", 1, hls_out, 1, "bram", "mem_rst", 1),
	Port_Property("dx_Addr_A", 32, hls_out, 2, "bram", "MemPortADDR2", 1),
	Port_Property("dx_EN_A", 1, hls_out, 2, "bram", "MemPortCE2", 1),
	Port_Property("dx_WEN_A", 4, hls_out, 2, "bram", "MemPortWE2", 1),
	Port_Property("dx_Din_A", 32, hls_out, 2, "bram", "MemPortDIN2", 1),
	Port_Property("dx_Dout_A", 32, hls_in, 2, "bram", "MemPortDOUT2", 1),
	Port_Property("dx_Clk_A", 1, hls_out, 2, "bram", "mem_clk", 1),
	Port_Property("dx_Rst_A", 1, hls_out, 2, "bram", "mem_rst", 1),
	Port_Property("y_Addr_A", 32, hls_out, 5, "bram", "MemPortADDR2", 1),
	Port_Property("y_EN_A", 1, hls_out, 5, "bram", "MemPortCE2", 1),
	Port_Property("y_WEN_A", 4, hls_out, 5, "bram", "MemPortWE2", 1),
	Port_Property("y_Din_A", 32, hls_out, 5, "bram", "MemPortDIN2", 1),
	Port_Property("y_Dout_A", 32, hls_in, 5, "bram", "MemPortDOUT2", 1),
	Port_Property("y_Clk_A", 1, hls_out, 5, "bram", "mem_clk", 1),
	Port_Property("y_Rst_A", 1, hls_out, 5, "bram", "mem_rst", 1),
	Port_Property("dy_Addr_A", 32, hls_out, 6, "bram", "MemPortADDR2", 1),
	Port_Property("dy_EN_A", 1, hls_out, 6, "bram", "MemPortCE2", 1),
	Port_Property("dy_WEN_A", 4, hls_out, 6, "bram", "MemPortWE2", 1),
	Port_Property("dy_Din_A", 32, hls_out, 6, "bram", "MemPortDIN2", 1),
	Port_Property("dy_Dout_A", 32, hls_in, 6, "bram", "MemPortDOUT2", 1),
	Port_Property("dy_Clk_A", 1, hls_out, 6, "bram", "mem_clk", 1),
	Port_Property("dy_Rst_A", 1, hls_out, 6, "bram", "mem_rst", 1),
