...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("x_WEN_A", 2, hls_out, 1, "bram", "MemPortWE2", 1),
	Port_Property("x_Din_A", 16, hls_out, 1, "bram", "MemPortDIN2", 1),
	Port_Property("x_Dout_A", 16, hls_in, 1, "bram", "MemPortDOUT2", 1),
	...
	Port_Property("dx_WEN_A", 2, hls_out, 2, "bram", "MemPortWE2", 1),
	Port_Property("dx_Din_A", 16, hls_out, 2, "bram", "MemPortDIN2", 1),
	Port_Property("dx_Dout_A", 16, hls_in, 2, "bram", "MemPortDOUT2", 1),
	...
	Port_Property("y_WEN_A", 2, hls_out, 5, "bram", "MemPortWE2", 1),
	Port_Property("y_Din_A", 16, hls_out, 5, "bram", "MemPortDIN2", 1),
	Port_Property("y_Dout_A", 16, hls_in, 5, "bram", "MemPortDOUT2", 1),
	...
	Port_Property("dy_WEN_A", 2, hls_out, 6, "bram", "MemPortWE2", 1),
	Port_Property("dy_Din_A", 16, hls_out, 6, "bram", "MemPortDIN2", 1),
	Port_Property("dy_Dout_A", 16, hls_in, 6, "bram", "MemPortDOUT2", 1),
