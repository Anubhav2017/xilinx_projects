...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("y_Addr_A", 32, hls_out, 6, "bram", "MemPortADDR2", 1),
	Port_Property("y_EN_A", 1, hls_out, 6, "bram", "MemPortCE2", 1),
	Port_Property("y_WEN_A", 2, hls_out, 6, "bram", "MemPortWE2", 1),
	Port_Property("y_Din_A", 16, hls_out, 6, "bram", "MemPortDIN2", 1),
	Port_Property("y_Dout_A", 16, hls_in, 6, "bram", "MemPortDOUT2", 1),
	Port_Property("y_Clk_A", 1, hls_out, 6, "bram", "mem_clk", 1),
	Port_Property("y_Rst_A", 1, hls_out, 6, "bram", "mem_rst", 1),
	Port_Property("dy_Addr_A", 32, hls_out, 7, "bram", "MemPortADDR2", 1),
	Port_Property("dy_EN_A", 1, hls_out, 7, "bram", "MemPortCE2", 1),
	Port_Property("dy_WEN_A", 2, hls_out, 7, "bram", "MemPortWE2", 1),
	Port_Property("dy_Din_A", 16, hls_out, 7, "bram", "MemPortDIN2", 1),
	Port_Property("dy_Dout_A", 16, hls_in, 7, "bram", "MemPortDOUT2", 1),
	Port_Property("dy_Clk_A", 1, hls_out, 7, "bram", "mem_clk", 1),
	Port_Property("dy_Rst_A", 1, hls_out, 7, "bram", "mem_rst", 1),
