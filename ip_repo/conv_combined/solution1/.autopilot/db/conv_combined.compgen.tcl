...
set id 27
set name conv_combined_mac_muladd_13s_13s_13ns_13_4_1
...
set id 28
set name conv_combined_mul_mul_13s_13s_13_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    delay_budget 7.3 \ 
    is_flushable 0 \ 
    name {conv_combined_gmem2_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv_combined_gmem2_m_axi
}
