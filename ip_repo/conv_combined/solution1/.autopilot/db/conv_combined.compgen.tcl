...
set id 1
set name conv_combined_mul_30s_30s_30_2_1
...
set id 9
set name conv_combined_mul_32s_32s_55_2_1
set corename simcore_mul
set op mul
set stage_num 2
set max_latency -1
...
set id 14
set name conv_combined_ama_addmuladd_10ns_10s_10s_10ns_10_4_1
...
set out_width 10
set exp (i0+i1)*i2+i3
set arg_lists {i0 {10 0 +} i1 {10 1 +} s {10 1 +} i2 {10 1 +} m {10 1 +} i3 {10 0 +} p {10 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
