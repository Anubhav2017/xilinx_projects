...
extern "C" void conv_combined(short*, short*, short*, int, int, short*, short*, __cosim_s2__, __cosim_s2__, int, int, int, int, char);
extern "C" void apatb_conv_combined_hw(volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_dx, volatile void * __xlx_apatb_param_wt, volatile void * __xlx_apatb_param_dwt, volatile void * __xlx_apatb_param_y, volatile void * __xlx_apatb_param_dy, __cosim_s2__ __xlx_apatb_param_b, __cosim_s2__ __xlx_apatb_param_db, int __xlx_apatb_param_H, int __xlx_apatb_param_W, int __xlx_apatb_param_FH, int __xlx_apatb_param_FW, char __xlx_apatb_param_fwprop) {
  ...
  vector<sc_bv<16> >__xlx_wt_dwt__tmp_vec;
  for (int j = 0, e = 200; j != e; ++j) {
    __xlx_wt_dwt__tmp_vec.push_back(((short*)__xlx_apatb_param_wt)[j]);
  }
  int __xlx_size_param_wt = 200;
  int __xlx_offset_param_wt = 0;
  int __xlx_offset_byte_param_wt = 0*2;
  for (int j = 0, e = 200; j != e; ++j) {
    __xlx_wt_dwt__tmp_vec.push_back(((short*)__xlx_apatb_param_dwt)[j]);
  }
  int __xlx_size_param_dwt = 200;
  int __xlx_offset_param_dwt = 200;
  int __xlx_offset_byte_param_dwt = 200*2;
  short* __xlx_wt_dwt__input_buffer= new short[__xlx_wt_dwt__tmp_vec.size()];
  for (int i = 0; i < __xlx_wt_dwt__tmp_vec.size(); ++i) {
    __xlx_wt_dwt__input_buffer[i] = __xlx_wt_dwt__tmp_vec[i].range(15, 0).to_uint64();
  }
