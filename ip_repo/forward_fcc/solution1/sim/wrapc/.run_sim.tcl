...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "forward_fcc.autotvin.dat"
	set constFileTvOut       "forward_fcc.autotvout.dat"
	set constFileHdlTvIn     "forward_fcc.autohdltvin.dat"
	set constFileHdlTvOut    "forward_fcc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
