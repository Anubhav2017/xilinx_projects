...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.forward_fcc.autotvin_gmem.dat"
         "c.forward_fcc.autotvin_x.dat"
         "c.forward_fcc.autotvin_w.dat"
         "c.forward_fcc.autotvin_y.dat"
         "c.forward_fcc.autotvin_b.dat"
         "c.forward_fcc.autotvin_xdim.dat"
         "c.forward_fcc.autotvin_ydim.dat"
         "c.forward_fcc.autotvout_gmem.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.forward_fcc.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
