...
if {[file isfile forward_fcc.autotvin.dat]} {
	file delete -force forward_fcc.autotvin.dat
}

if {[file isfile forward_fcc.autotvout.dat]} {
	file delete -force forward_fcc.autotvout.dat
}
