...
`define AUTOTB_DUT      forward_fcc
`define AUTOTB_DUT_INST AESL_inst_forward_fcc
`define AUTOTB_TOP      apatb_forward_fcc_top
`define AUTOTB_LAT_RESULT_FILE "forward_fcc.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "forward_fcc.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_forward_fcc_top
...
`define AESL_DEPTH_xdim 1
`define AESL_DEPTH_ydim 1
`define AUTOTB_TVIN_gmem  "./c.forward_fcc.autotvin_gmem.dat"
`define AUTOTB_TVIN_x  "./c.forward_fcc.autotvin_x.dat"
`define AUTOTB_TVIN_w  "./c.forward_fcc.autotvin_w.dat"
`define AUTOTB_TVIN_y  "./c.forward_fcc.autotvin_y.dat"
`define AUTOTB_TVIN_b  "./c.forward_fcc.autotvin_b.dat"
`define AUTOTB_TVIN_xdim  "./c.forward_fcc.autotvin_xdim.dat"
`define AUTOTB_TVIN_ydim  "./c.forward_fcc.autotvin_ydim.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.forward_fcc.autotvin_gmem.dat"
`define AUTOTB_TVIN_x_out_wrapc  "./rtl.forward_fcc.autotvin_x.dat"
`define AUTOTB_TVIN_w_out_wrapc  "./rtl.forward_fcc.autotvin_w.dat"
`define AUTOTB_TVIN_y_out_wrapc  "./rtl.forward_fcc.autotvin_y.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.forward_fcc.autotvin_b.dat"
`define AUTOTB_TVIN_xdim_out_wrapc  "./rtl.forward_fcc.autotvin_xdim.dat"
`define AUTOTB_TVIN_ydim_out_wrapc  "./rtl.forward_fcc.autotvin_ydim.dat"
`define AUTOTB_TVOUT_gmem  "./c.forward_fcc.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.forward_fcc.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_gmem = 80;
parameter LENGTH_x = 1;
parameter LENGTH_w = 1;
parameter LENGTH_y = 1;
parameter LENGTH_b = 1;
parameter LENGTH_xdim = 1;
parameter LENGTH_ydim = 1;
...
reg end_xdim;
reg [31:0] size_xdim;
reg [31:0] size_xdim_backup;
reg end_ydim;
reg [31:0] size_ydim;
reg [31:0] size_ydim_backup;
