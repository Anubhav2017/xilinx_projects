...
; Function Attrs: noinline
define internal fastcc void @copy_in([200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512) unnamed_addr #2 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0a200struct.ap_fixed([200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]* noalias) unnamed_addr #3 {
entry:
...
entry:
  %6 = bitcast %struct.ap_fixed* %0 to [200 x %struct.ap_fixed]*
  %7 = bitcast %struct.ap_fixed* %1 to [200 x %struct.ap_fixed]*
  %8 = bitcast %struct.ap_fixed* %2 to [200 x %struct.ap_fixed]*
  %9 = bitcast %struct.ap_fixed* %3 to [200 x %struct.ap_fixed]*
  call void @copy_out([200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %6, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %7, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %8, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %9)
  %10 = bitcast [200 x %struct.ap_fixed]* %6 to %struct.ap_fixed*
  %11 = bitcast [200 x %struct.ap_fixed]* %7 to %struct.ap_fixed*
  %12 = bitcast [200 x %struct.ap_fixed]* %8 to %struct.ap_fixed*
  %13 = bitcast [200 x %struct.ap_fixed]* %9 to %struct.ap_fixed*
  call void @forward_fcc_hw_stub(%struct.ap_fixed* %10, %struct.ap_fixed* %11, %struct.ap_fixed* %12, %struct.ap_fixed* %13, i32 %4, i32 %5)
  call void @copy_in([200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %6, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %7, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %8, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %9)
  ret void
}
