...
entity update_weights_control_s_axi is
generic (
...
end entity update_weights_control_s_axi;
...
architecture behave of update_weights_control_s_axi is
    ...
    constant ADDR_LR_DATA_0  : INTEGER := 16#20#;
    constant ADDR_LR_CTRL    : INTEGER := 16#24#;
    ...
    signal int_lr              : UNSIGNED(15 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_LR_DATA_0 =>
                        rdata_data <= RESIZE(int_lr(15 downto 0), 32);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LR_DATA_0) then
                    int_lr(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_lr(15 downto 0));
                end if;
            end if;
        end if;
    end process;
