...
// ==============================================================
#ifndef XBRAM_SWITCH_H
#define XBRAM_SWITCH_H
...
#ifndef __linux__
#define XBram_switch_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XBram_switch_ReadReg(BaseAddress, RegOffset) \
