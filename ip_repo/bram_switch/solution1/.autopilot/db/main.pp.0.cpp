...
# 3 "bram_switch/main.cpp" 2
typedef ap_fixed<16,3> fixed_t;


__attribute__((sdx_kernel("bram_switch", 0))) void bram_switch(fixed_t x[1024], fixed_t debugport[1024], fixed_t gradport[1024], fixed_t dummyport[1024], bool debug){_ssdm_SpecArrayDimSize(x, 1024);_ssdm_SpecArrayDimSize(debugport, 1024);_ssdm_SpecArrayDimSize(gradport, 1024);_ssdm_SpecArrayDimSize(dummyport, 1024);
#pragma HLS TOP name=bram_switch
# 6 "bram_switch/main.cpp"
