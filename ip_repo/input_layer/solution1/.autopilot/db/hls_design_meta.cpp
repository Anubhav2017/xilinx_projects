...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("bram_x_Addr_A", 32, hls_out, 3, "bram", "MemPortADDR2", 1),
	Port_Property("bram_x_EN_A", 1, hls_out, 3, "bram", "MemPortCE2", 1),
	Port_Property("bram_x_WEN_A", 2, hls_out, 3, "bram", "MemPortWE2", 1),
	Port_Property("bram_x_Din_A", 16, hls_out, 3, "bram", "MemPortDIN2", 1),
	Port_Property("bram_x_Dout_A", 16, hls_in, 3, "bram", "MemPortDOUT2", 1),
	Port_Property("bram_x_Clk_A", 1, hls_out, 3, "bram", "mem_clk", 1),
	Port_Property("bram_x_Rst_A", 1, hls_out, 3, "bram", "mem_rst", 1),
	Port_Property("bram_dx_Addr_A", 32, hls_out, 4, "bram", "MemPortADDR2", 1),
	Port_Property("bram_dx_EN_A", 1, hls_out, 4, "bram", "MemPortCE2", 1),
	Port_Property("bram_dx_WEN_A", 2, hls_out, 4, "bram", "MemPortWE2", 1),
	Port_Property("bram_dx_Din_A", 16, hls_out, 4, "bram", "MemPortDIN2", 1),
	Port_Property("bram_dx_Dout_A", 16, hls_in, 4, "bram", "MemPortDOUT2", 1),
	Port_Property("bram_dx_Clk_A", 1, hls_out, 4, "bram", "mem_clk", 1),
	Port_Property("bram_dx_Rst_A", 1, hls_out, 4, "bram", "mem_rst", 1),
...
const char* HLS_Design_Meta::dut_name = "InputLayer";
