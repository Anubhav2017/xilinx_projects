; ModuleID = '/home/anubhav/xilinx_projects/ip_repo/relu_bckwd/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_relu_bckwd_ir(%struct.ap_fixed* %x, %struct.ap_fixed* %dx, %struct.ap_fixed* %dy, i32 %dim) local_unnamed_addr #0 {
entry:
  ...
  %2 = bitcast %struct.ap_fixed* %dy to [200 x %struct.ap_fixed]*
  call fastcc void @copy_in([200 x %struct.ap_fixed]* %0, [200 x %struct.ap_fixed]* nonnull align 512 %x_copy, [200 x %struct.ap_fixed]* %1, [200 x %struct.ap_fixed]* nonnull align 512 %dx_copy, [200 x %struct.ap_fixed]* %2, [200 x %struct.ap_fixed]* nonnull align 512 %dy_copy)
  %3 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %x_copy, i32 0, i32 0
  %4 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %dx_copy, i32 0, i32 0
  %5 = getelementptr inbounds [200 x %struct.ap_fixed], [200 x %struct.ap_fixed]* %dy_copy, i32 0, i32 0
  call void @apatb_relu_bckwd_hw(%struct.ap_fixed* %3, %struct.ap_fixed* %4, %struct.ap_fixed* %5, i32 %dim)
  call fastcc void @copy_out([200 x %struct.ap_fixed]* %0, [200 x %struct.ap_fixed]* nonnull align 512 %x_copy, [200 x %struct.ap_fixed]* %1, [200 x %struct.ap_fixed]* nonnull align 512 %dx_copy, [200 x %struct.ap_fixed]* %2, [200 x %struct.ap_fixed]* nonnull align 512 %dy_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in([200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512, [200 x %struct.ap_fixed]*, [200 x %struct.ap_fixed]* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_relu_bckwd_hw(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32)

define void @relu_bckwd_hw_stub_wrapper(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32) #6 {
entry:
  %4 = bitcast %struct.ap_fixed* %0 to [200 x %struct.ap_fixed]*
  %5 = bitcast %struct.ap_fixed* %1 to [200 x %struct.ap_fixed]*
  %6 = bitcast %struct.ap_fixed* %2 to [200 x %struct.ap_fixed]*
  call void @copy_out([200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %4, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %5, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %6)
  %7 = bitcast [200 x %struct.ap_fixed]* %4 to %struct.ap_fixed*
  %8 = bitcast [200 x %struct.ap_fixed]* %5 to %struct.ap_fixed*
  %9 = bitcast [200 x %struct.ap_fixed]* %6 to %struct.ap_fixed*
  call void @relu_bckwd_hw_stub(%struct.ap_fixed* %7, %struct.ap_fixed* %8, %struct.ap_fixed* %9, i32 %3)
  call void @copy_in([200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %4, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %5, [200 x %struct.ap_fixed]* null, [200 x %struct.ap_fixed]* %6)
  ret void
}

declare void @relu_bckwd_hw_stub(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32)
