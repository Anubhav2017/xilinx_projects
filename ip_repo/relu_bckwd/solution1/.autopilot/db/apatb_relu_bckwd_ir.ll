; ModuleID = '/home/anubhav/workspace/ip_repo/relu_bckwd/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline
define void @apatb_relu_bckwd_ir(float* %x, float* %dx, float* %dy, i32 %dim) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_relu_bckwd_hw(float* %3, float* %4, float* %5, i32 %dim)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in([200 x float]* readonly, [200 x float]* noalias align 512, [200 x float]* readonly, [200 x float]* noalias align 512, [200 x float]* readonly, [200 x float]* noalias align 512) unnamed_addr #1 {
entry:
...
declare void @apatb_relu_bckwd_hw(float*, float*, float*, i32)

define void @relu_bckwd_hw_stub_wrapper(float*, float*, float*, i32) #5 {
entry:
  ...
  call void @relu_bckwd_hw_stub(float* %7, float* %8, float* %9, i32 %3)
  call void @copy_in([200 x float]* null, [200 x float]* %4, [200 x float]* null, [200 x float]* %5, [200 x float]* null, [200 x float]* %6)
  ret void
}

declare void @relu_bckwd_hw_stub(float*, float*, float*, i32)
