...
# 3 "bram_testip/main.cpp" 2


__attribute__((sdx_kernel("bram_test", 0))) void bram_test(volatile int* x1,volatile int* x2, int dim ){
#pragma HLS TOP name=bram_test
# 5 "bram_testip/main.cpp"
