...
HD_PWD='/home/anubhav/xilinx_projects/fcc_test/fcc_test/fcc_test.runs/design_1_fcc_dy_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fcc_dy_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fcc_dy_0.tcl
