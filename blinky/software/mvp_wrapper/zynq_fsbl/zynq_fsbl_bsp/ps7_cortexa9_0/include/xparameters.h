...
/* Definitions for driver FOO */
#define XPAR_XFOO_NUM_INSTANCES 1

/* Definitions for peripheral FOO_0 */
#define XPAR_FOO_0_DEVICE_ID 0
#define XPAR_FOO_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_FOO_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral FOO_0 */
#define XPAR_XFOO_0_DEVICE_ID XPAR_FOO_0_DEVICE_ID
#define XPAR_XFOO_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_XFOO_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF
