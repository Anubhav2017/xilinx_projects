...
Reset#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0}\
  ...
  connect_bd_net -net a_1 [get_bd_ports sw0] [get_bd_pins and_gate_0/a]
  connect_bd_net -net and_gate_0_y [get_bd_pins and_gate_0/y] [get_bd_pins axi_gpio_1/gpio_io_i]
  ...
  connect_bd_net -net sw1_1 [get_bd_ports sw1] [get_bd_pins and_gate_0/b]
