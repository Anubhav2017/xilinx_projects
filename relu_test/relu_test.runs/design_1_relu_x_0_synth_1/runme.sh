...
HD_PWD='/home/anubhav/xilinx_projects/relu_test/relu_test.runs/design_1_relu_x_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_relu_x_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_relu_x_0.tcl
