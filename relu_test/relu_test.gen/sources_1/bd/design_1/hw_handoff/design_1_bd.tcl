...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net InputLayer_1_bram_dx_PORTA [get_bd_intf_pins InputLayer_1/bram_dx_PORTA] [get_bd_intf_pins relu_dy/BRAM_PORTB]
  connect_bd_intf_net -intf_net InputLayer_1_bram_x_PORTA [get_bd_intf_pins InputLayer_1/bram_x_PORTA] [get_bd_intf_pins relu_y/BRAM_PORTB]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins relu_combined_0/s_axi_control]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs relu_combined_0/s_axi_control/Reg] -force
