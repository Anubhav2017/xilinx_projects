...
/* Definitions for driver DOT_MATRIX */
#define XPAR_XDOT_MATRIX_NUM_INSTANCES 1

/* Definitions for peripheral DOT_MATRIX_0 */
#define XPAR_DOT_MATRIX_0_DEVICE_ID 0
#define XPAR_DOT_MATRIX_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_DOT_MATRIX_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral DOT_MATRIX_0 */
#define XPAR_XDOT_MATRIX_0_DEVICE_ID XPAR_DOT_MATRIX_0_DEVICE_ID
#define XPAR_XDOT_MATRIX_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_XDOT_MATRIX_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF
