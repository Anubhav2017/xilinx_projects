...
extern "C" void float_vadd(int*, int, int, int, int);
extern "C" void apatb_float_vadd_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c, int __xlx_apatb_param_dimension) {
  ...
  // DUT call
  float_vadd(__xlx_a_b_c__input_buffer, __xlx_offset_byte_param_a, __xlx_offset_byte_param_b, __xlx_offset_byte_param_c, __xlx_apatb_param_dimension);
