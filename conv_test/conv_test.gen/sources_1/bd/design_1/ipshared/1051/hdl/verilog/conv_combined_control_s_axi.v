...
localparam
    ...
    ADDR_DB_CTRL         = 7'h2c,
    ADDR_DEBUG_X_DATA_0  = 7'h30,
    ADDR_DEBUG_X_CTRL    = 7'h34,
    ADDR_DEBUG_DX_DATA_0 = 7'h38,
    ADDR_DEBUG_DX_CTRL   = 7'h3c,
    ADDR_F_DATA_0        = 7'h40,
    ADDR_F_CTRL          = 7'h44,
    ADDR_C_DATA_0        = 7'h48,
    ADDR_C_CTRL          = 7'h4c,
    ...
    ADDR_FW_CTRL         = 7'h6c,
    ADDR_FWPROP_DATA_0   = 7'h70,
    ADDR_FWPROP_CTRL     = 7'h74,
    ADDR_DEBUGIP_DATA_0  = 7'h78,
    ADDR_DEBUGIP_CTRL    = 7'h7c,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
