...
HD_PWD='/home/anubhav/xilinx_projects/mnist_fcc/mnist_fcc.runs/design_1_fcc2_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fcc2_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fcc2_bram_0.tcl
