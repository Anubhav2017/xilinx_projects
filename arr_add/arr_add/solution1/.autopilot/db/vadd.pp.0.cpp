...
# 5 "vadd.cpp" 2
# 1 "/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/hls_burst_maxi.h" 1
# 14 "/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/hls_burst_maxi.h"
...
# 15 "/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/hls_burst_maxi.h" 2
...
# 16 "/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/hls_burst_maxi.h" 2
...
class burst_maxi {
public:
  burst_maxi(const burst_maxi<T> &p) : Ptr(p.Ptr) {
#pragma HLS inline
 }
...
#pragma HLS inline
 __fpga_maxi_write_req(&Ptr[offset], len);
  ...
  void write(const T &val, uint64_t be = -1ULL) {
#pragma HLS inline
 __fpga_maxi_write(Ptr, &val, be);
  }

  void write(const T &val, uint64_t be_low, uint64_t be_high) {
#pragma HLS inline
 __fpga_maxi_write(Ptr, &val, be_low, be_high);
  }
...
__attribute__((sdx_kernel("vadd", 0))) void vadd(volatile int* a,volatile int* b,volatile int* c){
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
 ...
 VITIS_LOOP_28_1: for(int i=0;i<dimension;i++){
