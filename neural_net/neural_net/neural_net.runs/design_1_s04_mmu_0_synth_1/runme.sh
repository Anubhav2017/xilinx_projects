...
HD_PWD='/home/anubhav/workspace/neural_net/neural_net/neural_net.runs/design_1_s04_mmu_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_s04_mmu_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_s04_mmu_0.tcl
