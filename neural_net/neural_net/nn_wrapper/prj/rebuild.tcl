...
#
# rebuild.tcl: Tcl script for re-creating project 'neural_net'
#
# Generated by Vivado on Thu Dec 16 22:44:49 IST 2021
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
   "/home/anubhav/workspace/neural_net/neural_net/neural_net.srcs/sources_1/bd/design_1/design_1.bd" \
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "neural_net"
...
set files [list \
 [file normalize "${origin_dir}/neural_net.srcs/sources_1/bd/design_1/design_1.bd" ]\
]
set imported_files [import_files -fileset sources_1 $files]

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/neural_net.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "pfm_name" -value "xilinx:pynq-z2:name:0.0" -objects $file_obj
