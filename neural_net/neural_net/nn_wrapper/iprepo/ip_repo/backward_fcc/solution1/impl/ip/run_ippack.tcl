...
set xo_kernel_name "backward_fcc"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/anubhav/workspace/ip_repo/backward_fcc/solution1"
set debug_dir "/home/anubhav/workspace/ip_repo/backward_fcc/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {backward_fcc_fmul_32ns_32ns_32_4_max_dsp_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 x_1 W 0x0 "Data signal of x" {{0 32 x W 0 "Bit 31 to 0 of x"}}} {0x14 x_2 W 0x0 "Data signal of x" {{0 32 x W 0 "Bit 63 to 32 of x"}}} {0x1c w_1 W 0x0 "Data signal of w" {{0 32 w W 0 "Bit 31 to 0 of w"}}} {0x20 w_2 W 0x0 "Data signal of w" {{0 32 w W 0 "Bit 63 to 32 of w"}}} {0x28 y_1 W 0x0 "Data signal of y" {{0 32 y W 0 "Bit 31 to 0 of y"}}} {0x2c y_2 W 0x0 "Data signal of y" {{0 32 y W 0 "Bit 63 to 32 of y"}}} {0x34 b_1 W 0x0 "Data signal of b" {{0 32 b W 0 "Bit 31 to 0 of b"}}} {0x38 b_2 W 0x0 "Data signal of b" {{0 32 b W 0 "Bit 63 to 32 of b"}}} {0x40 dx_1 W 0x0 "Data signal of dx" {{0 32 dx W 0 "Bit 31 to 0 of dx"}}} {0x44 dx_2 W 0x0 "Data signal of dx" {{0 32 dx W 0 "Bit 63 to 32 of dx"}}} {0x4c dy_1 W 0x0 "Data signal of dy" {{0 32 dy W 0 "Bit 31 to 0 of dy"}}} {0x50 dy_2 W 0x0 "Data signal of dy" {{0 32 dy W 0 "Bit 63 to 32 of dy"}}} {0x58 db_1 W 0x0 "Data signal of db" {{0 32 db W 0 "Bit 31 to 0 of db"}}} {0x5c db_2 W 0x0 "Data signal of db" {{0 32 db W 0 "Bit 63 to 32 of db"}}} {0x64 dw_1 W 0x0 "Data signal of dw" {{0 32 dw W 0 "Bit 31 to 0 of dw"}}} {0x68 dw_2 W 0x0 "Data signal of dw" {{0 32 dw W 0 "Bit 63 to 32 of dw"}}} {0x70 xdim W 0x0 "Data signal of xdim" {{0 32 xdim W 0 "Bit 31 to 0 of xdim"}}} {0x78 ydim W 0x0 "Data signal of ydim" {{0 32 ydim W 0 "Bit 31 to 0 of ydim"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
