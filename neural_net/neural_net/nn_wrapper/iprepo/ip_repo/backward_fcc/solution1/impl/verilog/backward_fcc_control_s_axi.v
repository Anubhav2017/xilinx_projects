...
// ==============================================================
`timescale 1ns/1ps
module backward_fcc_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_B_DATA_1    = 7'h38,
    ADDR_B_CTRL      = 7'h3c,
    ADDR_DX_DATA_0   = 7'h40,
    ADDR_DX_DATA_1   = 7'h44,
    ADDR_DX_CTRL     = 7'h48,
    ADDR_DY_DATA_0   = 7'h4c,
    ADDR_DY_DATA_1   = 7'h50,
    ADDR_DY_CTRL     = 7'h54,
    ADDR_DB_DATA_0   = 7'h58,
    ADDR_DB_DATA_1   = 7'h5c,
    ADDR_DB_CTRL     = 7'h60,
    ADDR_DW_DATA_0   = 7'h64,
    ADDR_DW_DATA_1   = 7'h68,
    ADDR_DW_CTRL     = 7'h6c,
    ADDR_XDIM_DATA_0 = 7'h70,
    ADDR_XDIM_CTRL   = 7'h74,
    ADDR_YDIM_DATA_0 = 7'h78,
    ADDR_YDIM_CTRL   = 7'h7c,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_DW_DATA_1)
            int_dw[63:32] <= (WDATA[31:0] & wmask) | (int_dw[63:32] & ~wmask);
    end
end
