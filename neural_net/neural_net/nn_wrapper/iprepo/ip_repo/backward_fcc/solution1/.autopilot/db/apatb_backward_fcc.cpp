...
// wrapc file define:
#define AUTOTB_TVIN_y "../tv/cdatafile/c.backward_fcc.autotvin_y.dat"
#define AUTOTB_TVOUT_y "../tv/cdatafile/c.backward_fcc.autotvout_y.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_y "../tv/rtldatafile/rtl.backward_fcc.autotvout_y.dat"
// tvout file define:
...
extern "C" void backward_fcc_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, int, int);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          if (i > 0) {{
            ...
            for (int j = 0, e = 100; j < e; j += 1, ++i) {
            ((int*)__xlx_apatb_param_db)[j] = gmem_pc_buffer[i].to_int64();
          }
            for (int j = 0, e = 100; j < e; j += 1, ++i) {
            ((int*)__xlx_apatb_param_dw)[j] = gmem_pc_buffer[i].to_int64();
          }}}
        } // end transaction
      } // end file is good
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_w)[j];
  ...
  __xlx_offset_byte_param_y = 200*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_y)[j];
  ...
  __xlx_offset_byte_param_b = 300*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_b)[j];
  ...
  __xlx_offset_byte_param_dx = 400*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_dx)[j];
  ...
  __xlx_offset_byte_param_dy = 500*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_dy)[j];
  ...
  __xlx_offset_byte_param_db = 600*4;
  if (__xlx_apatb_param_db) {
    for (int j = 0  - 0, e = 100 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_db)[j];

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_gmem, __xlx_sprintf_buffer.data()); 
      }
  }
  __xlx_offset_byte_param_dw = 700*4;
  if (__xlx_apatb_param_dw) {
    for (int j = 0  - 0, e = 100 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_dw)[j];
...
// print db Transactions
{
  ...
  {
    sc_bv<64> __xlx_tmp_lv = __xlx_offset_byte_param_db;
...
// print dw Transactions
{
  ...
  {
    sc_bv<64> __xlx_tmp_lv = __xlx_offset_byte_param_dw;
...
backward_fcc_hw_stub_wrapper(__xlx_apatb_param_x, __xlx_apatb_param_w, __xlx_apatb_param_y, __xlx_apatb_param_b, __xlx_apatb_param_dx, __xlx_apatb_param_dy, __xlx_apatb_param_db, __xlx_apatb_param_dw, __xlx_apatb_param_xdim, __xlx_apatb_param_ydim);
