...
HD_PWD='/home/anubhav/xilinx_projects/nn1/nn/nn.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fwd_fcc_test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fwd_fcc_test_wrapper.tcl
