...
HD_PWD='/home/anubhav/xilinx_projects/nn1/nn/nn.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fwd_fcc_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fwd_fcc_test_wrapper.tcl -notrace
