...
localparam
    ...
    ADDR_DEBUGIP_DATA_0  = 7'h40,
    ADDR_DEBUGIP_CTRL    = 7'h44,
    ADDR_XDIM_DATA_0     = 7'h48,
    ADDR_XDIM_CTRL       = 7'h4c,
    ADDR_YDIM_DATA_0     = 7'h50,
    ADDR_YDIM_CTRL       = 7'h54,
    ADDR_FWPROP_DATA_0   = 7'h58,
    ADDR_FWPROP_CTRL     = 7'h5c,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
