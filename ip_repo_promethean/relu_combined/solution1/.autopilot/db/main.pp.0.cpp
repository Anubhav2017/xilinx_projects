...
VITIS_LOOP_26_2: for(int i=0;i<dim;i++){
 ...
 if(fwprop == true){
  ...
  VITIS_LOOP_33_3: for(int i=0;i<dim;i++){
         if (xbuf[i] > 0){
             ybuf[i] = xbuf[i];
         }
         else{
  ...
  VITIS_LOOP_48_5: for(int i=0;i<dim;i++){
           if (xbuf[i] > 0){
               dxbuf[i] = dybuf[i];
           }
           else{
  ...
  VITIS_LOOP_56_6: for(int i=0;i<dim;i++){
   dx[i]=dxbuf[i];
  }
