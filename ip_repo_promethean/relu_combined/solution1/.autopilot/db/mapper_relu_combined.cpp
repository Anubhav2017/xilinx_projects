...
extern "C" void relu_combined(short*, int, int, int, int, int, char);
extern "C" void apatb_relu_combined_hw(volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_dx, volatile void * __xlx_apatb_param_y, volatile void * __xlx_apatb_param_dy, int __xlx_apatb_param_dim, char __xlx_apatb_param_fwprop) {
  // Collect __xlx_x_dx_y_dy__tmp_vec
  vector<sc_bv<16> >__xlx_x_dx_y_dy__tmp_vec;
  for (int j = 0, e = 1; j != e; ++j) {
    __xlx_x_dx_y_dy__tmp_vec.push_back(((short*)__xlx_apatb_param_x)[j]);
  }
  int __xlx_size_param_x = 1;
  int __xlx_offset_param_x = 0;
  int __xlx_offset_byte_param_x = 0*2;
  for (int j = 0, e = 1; j != e; ++j) {
    __xlx_x_dx_y_dy__tmp_vec.push_back(((short*)__xlx_apatb_param_dx)[j]);
  }
  int __xlx_size_param_dx = 1;
  int __xlx_offset_param_dx = 1;
  int __xlx_offset_byte_param_dx = 1*2;
  for (int j = 0, e = 1; j != e; ++j) {
    __xlx_x_dx_y_dy__tmp_vec.push_back(((short*)__xlx_apatb_param_y)[j]);
  }
  int __xlx_size_param_y = 1;
  int __xlx_offset_param_y = 2;
  int __xlx_offset_byte_param_y = 2*2;
  for (int j = 0, e = 1; j != e; ++j) {
    __xlx_x_dx_y_dy__tmp_vec.push_back(((short*)__xlx_apatb_param_dy)[j]);
  }
  int __xlx_size_param_dy = 1;
  int __xlx_offset_param_dy = 3;
  int __xlx_offset_byte_param_dy = 3*2;
  short* __xlx_x_dx_y_dy__input_buffer= new short[__xlx_x_dx_y_dy__tmp_vec.size()];
  for (int i = 0; i < __xlx_x_dx_y_dy__tmp_vec.size(); ++i) {
    __xlx_x_dx_y_dy__input_buffer[i] = __xlx_x_dx_y_dy__tmp_vec[i].range(15, 0).to_uint64();
  }
  // DUT call
  relu_combined(__xlx_x_dx_y_dy__input_buffer, __xlx_offset_byte_param_x, __xlx_offset_byte_param_dx, __xlx_offset_byte_param_y, __xlx_offset_byte_param_dy, __xlx_apatb_param_dim, __xlx_apatb_param_fwprop);
// print __xlx_apatb_param_x
  ...
  for (int i = 0; i < __xlx_size_param_x; ++i) {
    __xlx_x_output_buffer[i] = __xlx_x_dx_y_dy__input_buffer[i+__xlx_offset_param_x];
  }
  for (int i = 0; i < __xlx_size_param_x; ++i) {
...
// print __xlx_apatb_param_dx
  ...
  for (int i = 0; i < __xlx_size_param_dx; ++i) {
    __xlx_dx_output_buffer[i] = __xlx_x_dx_y_dy__input_buffer[i+__xlx_offset_param_dx];
  }
  for (int i = 0; i < __xlx_size_param_dx; ++i) {
...
// print __xlx_apatb_param_y
  ...
  for (int i = 0; i < __xlx_size_param_y; ++i) {
    __xlx_y_output_buffer[i] = __xlx_x_dx_y_dy__input_buffer[i+__xlx_offset_param_y];
  }
  for (int i = 0; i < __xlx_size_param_y; ++i) {
...
// print __xlx_apatb_param_dy
  ...
  for (int i = 0; i < __xlx_size_param_dy; ++i) {
    __xlx_dy_output_buffer[i] = __xlx_x_dx_y_dy__input_buffer[i+__xlx_offset_param_dy];
  }
  for (int i = 0; i < __xlx_size_param_dy; ++i) {
