; ModuleID = '/home/anubhav/xilinx_projects/ip_repo_promethean/relu_combined/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %y_copy3 = alloca %struct.ap_fixed, align 512
  %dy_copy4 = alloca %struct.ap_fixed, align 512
  call fastcc void @copy_in(%struct.ap_fixed* %x, %struct.ap_fixed* nonnull align 512 %x_copy1, %struct.ap_fixed* %dx, %struct.ap_fixed* nonnull align 512 %dx_copy2, %struct.ap_fixed* %y, %struct.ap_fixed* nonnull align 512 %y_copy3, %struct.ap_fixed* %dy, %struct.ap_fixed* nonnull align 512 %dy_copy4)
  call void @apatb_relu_combined_hw(%struct.ap_fixed* %x_copy1, %struct.ap_fixed* %dx_copy2, %struct.ap_fixed* %y_copy3, %struct.ap_fixed* %dy_copy4, i32 %dim, i1 %fwprop)
  call fastcc void @copy_out(%struct.ap_fixed* %x, %struct.ap_fixed* nonnull align 512 %x_copy1, %struct.ap_fixed* %dx, %struct.ap_fixed* nonnull align 512 %dx_copy2, %struct.ap_fixed* %y, %struct.ap_fixed* nonnull align 512 %y_copy3, %struct.ap_fixed* %dy, %struct.ap_fixed* nonnull align 512 %dy_copy4)
  ret void
}
...
entry:
  call void @copy_out(%struct.ap_fixed* null, %struct.ap_fixed* %0, %struct.ap_fixed* null, %struct.ap_fixed* %1, %struct.ap_fixed* null, %struct.ap_fixed* %2, %struct.ap_fixed* null, %struct.ap_fixed* %3)
  call void @relu_combined_hw_stub(%struct.ap_fixed* %0, %struct.ap_fixed* %1, %struct.ap_fixed* %2, %struct.ap_fixed* %3, i32 %4, i1 %5)
  call void @copy_in(%struct.ap_fixed* null, %struct.ap_fixed* %0, %struct.ap_fixed* null, %struct.ap_fixed* %1, %struct.ap_fixed* null, %struct.ap_fixed* %2, %struct.ap_fixed* null, %struct.ap_fixed* %3)
  ret void
}
