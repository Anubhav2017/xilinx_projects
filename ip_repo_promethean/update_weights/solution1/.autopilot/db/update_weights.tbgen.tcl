...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "w","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "w","bundle": "control"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "dw","cData": "short","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "dw","bundle": "control"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "lr", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "lr","cData": "short","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":32}, "offset_end" : {"in":39}} , 
 	{ "Name" : "dim", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "dim","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":40}, "offset_end" : {"in":47}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"update_weights","role":"start","value":"0","valid_bit":"0"},{"name":"update_weights","role":"continue","value":"0","valid_bit":"4"},{"name":"update_weights","role":"auto_start","value":"0","valid_bit":"7"},{"name":"w","role":"data","value":"16"},{"name":"dw","role":"data","value":"24"},{"name":"lr","role":"data","value":"32"},{"name":"dim","role":"data","value":"40"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"update_weights","role":"start","value":"0","valid_bit":"0"},{"name":"update_weights","role":"done","value":"0","valid_bit":"1"},{"name":"update_weights","role":"idle","value":"0","valid_bit":"2"},{"name":"update_weights","role":"ready","value":"0","valid_bit":"3"},{"name":"update_weights","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_mulsub_16s_16s_29ns_29_4_1_U1", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	update_weights {
		gmem {Type IO LastRead 30 FirstWrite 25}
