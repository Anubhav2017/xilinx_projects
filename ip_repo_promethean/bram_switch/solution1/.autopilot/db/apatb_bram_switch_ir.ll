; ModuleID = '/home/anubhav/xilinx_projects/ip_repo/bram_switch/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_bram_switch_ir(%struct.ap_fixed* %x, %struct.ap_fixed* %debugport, %struct.ap_fixed* %gradport, %struct.ap_fixed* %dummyport, i1 %debug) local_unnamed_addr #0 {
entry:
  %x_copy = alloca [1024 x %struct.ap_fixed], align 512
  %debugport_copy = alloca [1024 x %struct.ap_fixed], align 512
  %gradport_copy = alloca [1024 x %struct.ap_fixed], align 512
  %dummyport_copy = alloca [1024 x %struct.ap_fixed], align 512
  %0 = bitcast %struct.ap_fixed* %x to [1024 x %struct.ap_fixed]*
  %1 = bitcast %struct.ap_fixed* %debugport to [1024 x %struct.ap_fixed]*
  %2 = bitcast %struct.ap_fixed* %gradport to [1024 x %struct.ap_fixed]*
  %3 = bitcast %struct.ap_fixed* %dummyport to [1024 x %struct.ap_fixed]*
  call fastcc void @copy_in([1024 x %struct.ap_fixed]* %0, [1024 x %struct.ap_fixed]* nonnull align 512 %x_copy, [1024 x %struct.ap_fixed]* %1, [1024 x %struct.ap_fixed]* nonnull align 512 %debugport_copy, [1024 x %struct.ap_fixed]* %2, [1024 x %struct.ap_fixed]* nonnull align 512 %gradport_copy, [1024 x %struct.ap_fixed]* %3, [1024 x %struct.ap_fixed]* nonnull align 512 %dummyport_copy)
  call fastcc void @copy_out([1024 x %struct.ap_fixed]* %0, [1024 x %struct.ap_fixed]* nonnull align 512 %x_copy, [1024 x %struct.ap_fixed]* %1, [1024 x %struct.ap_fixed]* nonnull align 512 %debugport_copy, [1024 x %struct.ap_fixed]* %2, [1024 x %struct.ap_fixed]* nonnull align 512 %gradport_copy, [1024 x %struct.ap_fixed]* %3, [1024 x %struct.ap_fixed]* nonnull align 512 %dummyport_copy)
  ret void
}
