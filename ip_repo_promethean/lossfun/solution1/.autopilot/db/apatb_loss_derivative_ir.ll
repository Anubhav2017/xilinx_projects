; ModuleID = '/home/anubhav/xilinx_projects/ip_repo_promethean/lossfun/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define internal fastcc void @copy_in(%struct.ap_fixed*, %struct.ap_fixed* noalias align 512, %struct.ap_fixed*, %struct.ap_fixed* noalias align 512) unnamed_addr #0 {
entry:
...
define internal fastcc void @streamcpy_hls.p0struct.ap_fixed(%struct.ap_fixed* noalias nocapture align 512, %struct.ap_fixed* noalias nocapture) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_fixed_base(%struct.ap_fixed_base* noalias nocapture align 512, %struct.ap_fixed_base* noalias nocapture) unnamed_addr #2 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%struct.ap_fixed*, %struct.ap_fixed* noalias align 512, %struct.ap_fixed*, %struct.ap_fixed* noalias align 512) unnamed_addr #4 {
entry:
...
declare void @apatb_loss_derivative_hw(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32, i32)

define void @loss_derivative_hw_stub_wrapper(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32, i32) #5 {
entry:
  call void @copy_out(%struct.ap_fixed* null, %struct.ap_fixed* %1, %struct.ap_fixed* null, %struct.ap_fixed* %2)
  call void @loss_derivative_hw_stub(%struct.ap_fixed* %0, %struct.ap_fixed* %1, %struct.ap_fixed* %2, i32 %3, i32 %4)
  call void @copy_in(%struct.ap_fixed* null, %struct.ap_fixed* %1, %struct.ap_fixed* null, %struct.ap_fixed* %2)
  ret void
}

declare void @loss_derivative_hw_stub(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, i32, i32)

; Function Attrs: noinline
define void @apatb_loss_derivative_ir(i16* %ret, %struct.ap_fixed* %x, %struct.ap_fixed* %dx, i32 %y, i32 %dim) #6 {
entry:
  %x_copy1 = alloca %struct.ap_fixed, align 512
  %dx_copy2 = alloca %struct.ap_fixed, align 512
  call fastcc void @copy_in(%struct.ap_fixed* %x, %struct.ap_fixed* nonnull align 512 %x_copy1, %struct.ap_fixed* %dx, %struct.ap_fixed* nonnull align 512 %dx_copy2)
  %0 = alloca %struct.ap_fixed
  call void @apatb_loss_derivative_hw(%struct.ap_fixed* %0, %struct.ap_fixed* %x_copy1, %struct.ap_fixed* %dx_copy2, i32 %y, i32 %dim)
  %1 = load volatile %struct.ap_fixed, %struct.ap_fixed* %0
  call fastcc void @copy_out(%struct.ap_fixed* %x, %struct.ap_fixed* nonnull align 512 %x_copy1, %struct.ap_fixed* %dx, %struct.ap_fixed* nonnull align 512 %dx_copy2)
