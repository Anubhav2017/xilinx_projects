...
#define XLOSS_DERIVATIVE_CONTROL_ADDR_X_DATA    0x18
#define XLOSS_DERIVATIVE_CONTROL_BITS_X_DATA    32
#define XLOSS_DERIVATIVE_CONTROL_ADDR_DX_DATA   0x20
#define XLOSS_DERIVATIVE_CONTROL_BITS_DX_DATA   32
