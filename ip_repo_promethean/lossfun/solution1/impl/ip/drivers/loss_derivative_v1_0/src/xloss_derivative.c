...
void XLoss_derivative_Set_x(XLoss_derivative *InstancePtr, u32 Data) {
    ...
    XLoss_derivative_WriteReg(InstancePtr->Control_BaseAddress, XLOSS_DERIVATIVE_CONTROL_ADDR_X_DATA, Data);
}
...
u32 XLoss_derivative_Get_x(XLoss_derivative *InstancePtr) {
    ...
    Data = XLoss_derivative_ReadReg(InstancePtr->Control_BaseAddress, XLOSS_DERIVATIVE_CONTROL_ADDR_X_DATA);
    return Data;
}
...
void XLoss_derivative_Set_dx(XLoss_derivative *InstancePtr, u32 Data) {
    ...
    XLoss_derivative_WriteReg(InstancePtr->Control_BaseAddress, XLOSS_DERIVATIVE_CONTROL_ADDR_DX_DATA, Data);
}
...
u32 XLoss_derivative_Get_dx(XLoss_derivative *InstancePtr) {
    ...
    Data = XLoss_derivative_ReadReg(InstancePtr->Control_BaseAddress, XLOSS_DERIVATIVE_CONTROL_ADDR_DX_DATA);
    return Data;
}
