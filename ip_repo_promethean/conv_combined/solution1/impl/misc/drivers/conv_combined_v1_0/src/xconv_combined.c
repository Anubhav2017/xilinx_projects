...
void XConv_combined_Set_x(XConv_combined *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_combined_WriteReg(InstancePtr->Control_BaseAddress, XCONV_COMBINED_CONTROL_ADDR_X_DATA, Data);
}

u32 XConv_combined_Get_x(XConv_combined *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_combined_ReadReg(InstancePtr->Control_BaseAddress, XCONV_COMBINED_CONTROL_ADDR_X_DATA);
    return Data;
}

void XConv_combined_Set_dx(XConv_combined *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_combined_WriteReg(InstancePtr->Control_BaseAddress, XCONV_COMBINED_CONTROL_ADDR_DX_DATA, Data);
}

u32 XConv_combined_Get_dx(XConv_combined *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_combined_ReadReg(InstancePtr->Control_BaseAddress, XCONV_COMBINED_CONTROL_ADDR_DX_DATA);
    return Data;
}
...
void XConv_combined_Set_y(XConv_combined *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_combined_WriteReg(InstancePtr->Control_BaseAddress, XCONV_COMBINED_CONTROL_ADDR_Y_DATA, Data);
}

u32 XConv_combined_Get_y(XConv_combined *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_combined_ReadReg(InstancePtr->Control_BaseAddress, XCONV_COMBINED_CONTROL_ADDR_Y_DATA);
    return Data;
}

void XConv_combined_Set_dy(XConv_combined *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_combined_WriteReg(InstancePtr->Control_BaseAddress, XCONV_COMBINED_CONTROL_ADDR_DY_DATA, Data);
}

u32 XConv_combined_Get_dy(XConv_combined *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_combined_ReadReg(InstancePtr->Control_BaseAddress, XCONV_COMBINED_CONTROL_ADDR_DY_DATA);
    return Data;
}
