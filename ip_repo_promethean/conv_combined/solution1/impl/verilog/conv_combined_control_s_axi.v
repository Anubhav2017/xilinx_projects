...
// ==============================================================
`timescale 1ns/1ps
module conv_combined_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_X_DATA_0      = 8'h10,
    ADDR_X_CTRL        = 8'h14,
    ADDR_DX_DATA_0     = 8'h18,
    ADDR_DX_CTRL       = 8'h1c,
    ADDR_WT_DATA_0     = 8'h20,
    ADDR_WT_CTRL       = 8'h24,
    ADDR_DWT_DATA_0    = 8'h28,
    ADDR_DWT_CTRL      = 8'h2c,
    ADDR_Y_DATA_0      = 8'h30,
    ADDR_Y_CTRL        = 8'h34,
    ADDR_DY_DATA_0     = 8'h38,
    ADDR_DY_CTRL       = 8'h3c,
    ADDR_B_DATA_0      = 8'h40,
    ADDR_B_CTRL        = 8'h44,
    ADDR_DB_DATA_0     = 8'h48,
    ADDR_DB_CTRL       = 8'h4c,
    ADDR_F_DATA_0      = 8'h50,
    ADDR_F_CTRL        = 8'h54,
    ADDR_C_DATA_0      = 8'h58,
    ...
    ADDR_W_DATA_0      = 8'h68,
    ADDR_W_CTRL        = 8'h6c,
    ADDR_FH_DATA_0     = 8'h70,
    ADDR_FH_CTRL       = 8'h74,
    ADDR_FW_DATA_0     = 8'h78,
    ADDR_FW_CTRL       = 8'h7c,
    ADDR_FWPROP_DATA_0 = 8'h80,
    ADDR_FWPROP_CTRL   = 8'h84,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_FH_DATA_0: begin
                    rdata <= int_FH[31:0];
                end
                ADDR_FW_DATA_0: begin
                    rdata <= int_FW[31:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_FH_DATA_0)
            int_FH[31:0] <= (WDATA[31:0] & wmask) | (int_FH[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_FW_DATA_0)
            int_FW[31:0] <= (WDATA[31:0] & wmask) | (int_FW[31:0] & ~wmask);
    end
end
