...
extern "C" void conv_combined_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, int, int, int, int, int, int, char);
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<16> > gmem_pc_buffer(1600);
          int i = 0;
...
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_dx)[j];
  ...
  __xlx_offset_byte_param_wt = 400*2;
...
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_wt)[j];
  ...
  __xlx_offset_byte_param_dwt = 600*2;
...
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_dwt)[j];
  ...
  __xlx_offset_byte_param_y = 800*2;
...
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_dy)[j];
  ...
  __xlx_offset_byte_param_b = 1200*2;
...
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_b)[j];
  ...
  __xlx_offset_byte_param_db = 1400*2;
...
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_db)[j];
  ...
  tcl_file.set_num(1600, &tcl_file.gmem_depth);
