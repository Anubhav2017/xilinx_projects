...
# 6 "conv_combined/main.cpp" 2
typedef ap_fixed<16,3> fixed_t;

__attribute__((sdx_kernel("conv_combined", 0))) void conv_combined(fixed_t* x, fixed_t* dx,fixed_t* wt,fixed_t* dwt, fixed_t* y, fixed_t* dy,fixed_t* b,fixed_t* db, int F, int C, int H, int W, int FH, int FW, bool fwprop){
#pragma HLS TOP name=conv_combined
# 8 "conv_combined/main.cpp"
...
#pragma HLS INTERFACE s_axilite port=return
 ...
 fixed_t wbuf[32][32][3][3];
 fixed_t dwbuf[32][32][3][3];
 ...
 VITIS_LOOP_46_1: for(int i=0;i<F;i++){
         VITIS_LOOP_47_2: for(int j=0;j<C;j++){
             VITIS_LOOP_48_3: for(int k=0;k<FH;k++){
                 VITIS_LOOP_49_4: for(int l=0;l<FW;l++){
 ...
 VITIS_LOOP_59_5: for(int i=0;i<F;i++){
    bbuf[i] = b[i];
 }

 VITIS_LOOP_63_6: for(int i=0;i<C*H*W;i++){
  xbuf[i]=x[i];
 }
 ...
 if(fwprop == true){
  ...
  VITIS_LOOP_71_7: for(int i=0;i<C*H*W;i++){
   dxbuf[i]=0;
  }

  VITIS_LOOP_75_8: for(int f=0;f<F;f++){
          VITIS_LOOP_76_9: for(int c=0;c<C;c++){
              VITIS_LOOP_77_10: for(int h=0;h<outH;h++){
                  VITIS_LOOP_78_11: for(int w=0;w<outW;w++){
                      ybuf[f*outH*outW+h*outW+w]=bbuf[f];
                      VITIS_LOOP_80_12: for(int fh=0;fh<FH;fh++){
                          VITIS_LOOP_81_13: for(int fw=0;fw<FW;fw++){
  ...
  VITIS_LOOP_90_14: for(int i=0;i<F*outH*outW;i++){
   y[i]=ybuf[i];
  }
  ...
  VITIS_LOOP_97_15: for(int i=0;i<F;i++){
     dbbuf[i] = db[i];
  }


  VITIS_LOOP_102_16: for(int i=0;i<F;i++){
          VITIS_LOOP_103_17: for(int j=0;j<C;j++){
              VITIS_LOOP_104_18: for(int k=0;k<FH;k++){
                  VITIS_LOOP_105_19: for(int l=0;l<FW;l++){
  ...
  VITIS_LOOP_112_20: for(int f=0;f<F;f++){
          VITIS_LOOP_113_21: for(int h=0;h<outH;h++){
              VITIS_LOOP_114_22: for(int w=0;w<outW;w++){
                  VITIS_LOOP_115_23: for(int c=0;c<C;c++){
                      VITIS_LOOP_116_24: for(int fh=0;fh<FH;fh++){
                          VITIS_LOOP_117_25: for(int fw=0;fw<FW;fw++){
  ...
  VITIS_LOOP_129_26: for(int i=0;i<F;i++){
            VITIS_LOOP_130_27: for(int j=0;j<C;j++){
                VITIS_LOOP_131_28: for(int k=0;k<FH;k++){
                    VITIS_LOOP_132_29: for(int l=0;l<FW;l++){
  ...
  VITIS_LOOP_140_30: for(int i=0;i<F;i++){
   db[i] = dbbuf[i];
  }

  VITIS_LOOP_144_31: for(int i=0;i<C*H*W;i++){
   dx[i]= dxbuf[i];
  }
