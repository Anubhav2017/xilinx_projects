...
set C_modelName {bram_test}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 2}  }
	{ x1 int 32 regular {axi_slave 0}  }
	{ x2 int 32 regular {axi_slave 0}  }
	{ dim int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "x1","cData": "int","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "x1","bundle": "CTRL"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "x2","cData": "int","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "x2","bundle": "CTRL"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	{ "Name" : "x1", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "x2", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} , 
...
set NewPortList {[ 
	{ "name": "s_axi_CTRL_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CTRL", "role": "AWADDR" },"address":[{"name":"bram_test","role":"start","value":"0","valid_bit":"0"},{"name":"bram_test","role":"continue","value":"0","valid_bit":"4"},{"name":"bram_test","role":"auto_start","value":"0","valid_bit":"7"},{"name":"x1","role":"data","value":"16"},{"name":"x2","role":"data","value":"24"},{"name":"dim","role":"data","value":"32"}] },
	...
	{ "name": "s_axi_CTRL_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CTRL", "role": "ARADDR" },"address":[{"name":"bram_test","role":"start","value":"0","valid_bit":"0"},{"name":"bram_test","role":"done","value":"0","valid_bit":"1"},{"name":"bram_test","role":"idle","value":"0","valid_bit":"2"},{"name":"bram_test","role":"ready","value":"0","valid_bit":"3"},{"name":"bram_test","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bram_x14_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	bram_test {
		gmem {Type IO LastRead 11 FirstWrite 12}
