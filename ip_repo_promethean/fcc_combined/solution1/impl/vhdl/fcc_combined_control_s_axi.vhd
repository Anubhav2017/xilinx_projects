...
entity fcc_combined_control_s_axi is
generic (
...
end entity fcc_combined_control_s_axi;
...
architecture behave of fcc_combined_control_s_axi is
    ...
    constant ADDR_B_DATA_0      : INTEGER := 16#30#;
    constant ADDR_B_CTRL        : INTEGER := 16#34#;
    constant ADDR_DB_DATA_0     : INTEGER := 16#38#;
    constant ADDR_DB_CTRL       : INTEGER := 16#3c#;
    constant ADDR_Y_DATA_0      : INTEGER := 16#40#;
    constant ADDR_Y_CTRL        : INTEGER := 16#44#;
    constant ADDR_DY_DATA_0     : INTEGER := 16#48#;
    constant ADDR_DY_CTRL       : INTEGER := 16#4c#;
    constant ADDR_XDIM_DATA_0   : INTEGER := 16#50#;
    constant ADDR_XDIM_CTRL     : INTEGER := 16#54#;
    constant ADDR_YDIM_DATA_0   : INTEGER := 16#58#;
    constant ADDR_YDIM_CTRL     : INTEGER := 16#5c#;
