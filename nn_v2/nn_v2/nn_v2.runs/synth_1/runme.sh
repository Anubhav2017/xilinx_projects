...
HD_PWD='/home/anubhav/xilinx_projects/nn_v2/nn_v2/nn_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nn_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nn_wrapper.tcl
