...
HD_PWD='/home/anubhav/xilinx_projects/nn_v2/nn_v2/nn_v2.runs/nn_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nn_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nn_xbar_1.tcl
