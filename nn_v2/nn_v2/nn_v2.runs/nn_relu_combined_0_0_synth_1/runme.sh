...
HD_PWD='/home/anubhav/xilinx_projects/nn_v2/nn_v2/nn_v2.runs/nn_relu_combined_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nn_relu_combined_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nn_relu_combined_0_0.tcl
