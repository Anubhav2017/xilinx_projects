...
HD_PWD='/home/anubhav/xilinx_projects/nn_v2/nn_v2/nn_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nn_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nn_wrapper.tcl -notrace
