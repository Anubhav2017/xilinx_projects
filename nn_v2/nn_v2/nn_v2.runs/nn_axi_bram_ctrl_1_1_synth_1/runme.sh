...
HD_PWD='/home/anubhav/xilinx_projects/nn_v2/nn_v2/nn_v2.runs/nn_axi_bram_ctrl_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nn_axi_bram_ctrl_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nn_axi_bram_ctrl_1_1.tcl
