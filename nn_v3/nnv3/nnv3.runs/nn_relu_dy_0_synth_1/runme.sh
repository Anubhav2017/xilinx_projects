...
HD_PWD='/home/anubhav/xilinx_projects/nn_v3/nnv3/nnv3.runs/nn_relu_dy_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nn_relu_dy_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nn_relu_dy_0.tcl
